...
${nuget_cmd} install src/PollinationSDK/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/PollinationSDK.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/PollinationSDK.dll \
-recurse:'src/PollinationSDK/*.cs' \
-doc:bin/PollinationSDK.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/PollinationSDK.dll was created successfully"
fi
