...
namespace PollinationSDK
{
    ...
    /// LicensePoolUpdate
    /// </summary>
    [DataContract(Name = "LicensePoolUpdate")]
    public partial class LicensePoolUpdate : OpenAPIGenBaseModel, IEquatable<LicensePoolUpdate>, IValidatableObject
    {
        /// <summary>
        ...
        {
            var obj = JsonConvert.DeserializeObject<LicensePoolUpdate>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>LicensePoolUpdate object</returns>
        public virtual LicensePoolUpdate DuplicateLicensePoolUpdate()
        {
        ...
        {
            return DuplicateLicensePoolUpdate();
        }
