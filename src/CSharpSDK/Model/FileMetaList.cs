...
namespace PollinationSDK
{
    ...
    /// </summary>
    [DataContract(Name = "FileMetaList")]
    public partial class FileMetaList : OpenAPIGenBaseModel, IEquatable<FileMetaList>, IValidatableObject
    {
        /// <summary>
        ...
        public FileMetaList
        (
           int page, int perPage, int pageCount, int totalCount, List<FileMeta> resources, // Required parameters
        ...
        ) : base()// BaseClass
        {
            ...
            this.Resources = resources ?? throw new ArgumentNullException("resources is a required property for FileMetaList and cannot be null");
        ...
        public override string Type { get; protected set; }  = "FileMetaList";
        ...
        {
            var obj = JsonConvert.DeserializeObject<FileMetaList>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>FileMetaList object</returns>
        public virtual FileMetaList DuplicateFileMetaList()
        {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^FileMetaList$", RegexOptions.CultureInvariant);
