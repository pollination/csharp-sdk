...
namespace PollinationSDK.Model
{
    ...
    public partial class NewPluginPackage :  IEquatable<NewPluginPackage>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            if (manifest == null)
            {
                throw new InvalidDataException("manifest is a required property for NewPluginPackage and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewPluginPackage {\n");
        ...
        {
            var obj = JsonConvert.DeserializeObject<NewPluginPackage>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>NewPluginPackage object</returns>
        public NewPluginPackage DuplicateNewPluginPackage()
        {
