...
namespace PollinationSDK.Model
{
    ...
    public partial class InvoicePreview :  IEquatable<InvoicePreview>, IValidatableObject
    {
        ...
        (
           ...
           bool autoAdvance= default, string description= default, List<Discount> discounts= default, string hostedInvoiceUrl= default, CardPublic paymentMethod= default, string subscription= default, List<DiscountAmount> totalDiscountAmounts= default// Optional parameters
        )// BaseClass
        {
