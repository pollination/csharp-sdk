...
namespace PollinationSDK.Model
{
    ...
    public partial class InvoicePreview :  IEquatable<InvoicePreview>, IValidatableObject
    {
        ...
        (
           string collectionMethod, string currency, string customer, LineItemList lines, DateTime periodEnd, DateTime periodStart, InvoiceStatus status, string subscription, int total, // Required parameters
