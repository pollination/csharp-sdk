...
namespace PollinationSDK
{
    ...
    public partial class StepStatus : IEquatable<StepStatus>, IValidatableObject
    {
        ...
        (
           ...
           Dictionary<string, string> annotations= default, string boundaryId= default, string command= default, DateTime finishedAt= default, string message= default, string source= default, StepStatusEnum status= StepStatusEnum.Unknown // Optional parameters
        )// BaseClass
        {
