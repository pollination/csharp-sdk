...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StepList :  IEquatable<StepList>, IValidatableObject
    {
        /// <summary>
        ...
        public StepList
        (
           int page, int pageCount, int perPage, List<StepStatus> resources, int totalCount, // Required parameters
        ...
        )// BaseClass
        {
            ...
            if (page == null)
            {
                throw new InvalidDataException("page is a required property for StepList and cannot be null");
            }
            else
            {
                this.Page = page;
            ...
            if (pageCount == null)
            {
                throw new InvalidDataException("pageCount is a required property for StepList and cannot be null");
            }
            else
            {
            ...
            if (perPage == null)
            {
                throw new InvalidDataException("perPage is a required property for StepList and cannot be null");
            }
            else
            {
            ...
            if (resources == null)
            {
                throw new InvalidDataException("resources is a required property for StepList and cannot be null");
            }
            else
            {
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for StepList and cannot be null");
            }
            else
            {
        ...
        public List<StepStatus> Resources { get; set; } 
        /// <summary>
        ...
        /// </summary>
        /// <returns>StepList object</returns>
        public static StepList FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<StepList>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>StepList object</returns>
        public StepList DuplicateStepList()
        {
        ...
        {
            return this.Equals(input as StepList);
        }

        /// <summary>
        /// Returns true if StepList instances are equal
        /// </summary>
        /// <param name="input">Instance of StepList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StepList input)
        {
            if (input == null)
                return false;
            return 
