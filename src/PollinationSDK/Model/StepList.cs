...
namespace PollinationSDK
{
    ...
    public partial class StepList : OpenAPIGenBaseModel, IEquatable<StepList>, IValidatableObject
    {
        ...
        public StepList
        (
           int page, int perPage, int pageCount, int totalCount, List<StepStatus> resources, // Required parameters
        ...
        ) : base()// BaseClass
        {
            ...
            this.Resources = resources ?? throw new ArgumentNullException("resources is a required property for StepList and cannot be null");
        ...
        public override string Type { get; protected internal set; }  = "StepList";
        ...
        {
            var obj = JsonConvert.DeserializeObject<StepList>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>StepList object</returns>
        public virtual StepList DuplicateStepList()
        {
