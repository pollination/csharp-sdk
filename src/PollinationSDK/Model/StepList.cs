...
namespace PollinationSDK.Model
{
    ...
    public partial class StepList : OpenAPIGenBaseModel,  IEquatable<StepList>, IValidatableObject
    {
        /// <summary>
        ...
        public StepList(int page = default(int), int perPage = default(int), int pageCount = default(int), int totalCount = default(int), List<StepStatus> resources = default(List<StepStatus>), int nextPage = default(int)) : base()
        {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^StepList$", RegexOptions.CultureInvariant);
