...
namespace PollinationSDK
{
    ...
    /// </summary>
    [DataContract(Name = "RepositoryList")]
    public partial class RepositoryList : OpenAPIGenBaseModel, IEquatable<RepositoryList>, IValidatableObject
    {
        ...
        (
           int page, int perPage, int pageCount, int totalCount, List<Repository> resources, // Required parameters
        ...
        ) : base()// BaseClass
        {
            ...
            this.Resources = resources ?? throw new ArgumentNullException("resources is a required property for RepositoryList and cannot be null");
        ...
        public override string Type { get; protected internal set; }  = "RepositoryList";
        ...
        {
            var obj = JsonConvert.DeserializeObject<RepositoryList>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>RepositoryList object</returns>
        public virtual RepositoryList DuplicateRepositoryList()
        {
        ...
        {
            return DuplicateRepositoryList();
        }
