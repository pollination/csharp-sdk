...
namespace PollinationSDK.Model
{
    ...
    public partial class RepositoryList : OpenAPIGenBaseModel,  IEquatable<RepositoryList>, IValidatableObject
    {
        /// <summary>
        ...
        public RepositoryList(int page = default(int), int perPage = default(int), int pageCount = default(int), int totalCount = default(int), List<Repository> resources = default(List<Repository>), int nextPage = default(int)) : base()
        {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^RepositoryList$", RegexOptions.CultureInvariant);
