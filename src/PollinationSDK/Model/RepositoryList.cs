...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RepositoryList :  IEquatable<RepositoryList>, IValidatableObject
    {
        /// <summary>
        ...
        (
           int page, int pageCount, int perPage, List<Repository> resources, int totalCount, // Required parameters
        ...
        )// BaseClass
        {
            ...
            if (page == null)
            {
                throw new InvalidDataException("page is a required property for RepositoryList and cannot be null");
            }
            else
            {
                this.Page = page;
            ...
            if (pageCount == null)
            {
                throw new InvalidDataException("pageCount is a required property for RepositoryList and cannot be null");
            }
            else
            {
            ...
            if (perPage == null)
            {
                throw new InvalidDataException("perPage is a required property for RepositoryList and cannot be null");
            }
            else
            {
            ...
            if (resources == null)
            {
                throw new InvalidDataException("resources is a required property for RepositoryList and cannot be null");
            }
            else
            {
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for RepositoryList and cannot be null");
            }
            else
            {
        ...
        public List<Repository> Resources { get; set; } 
        /// <summary>
        ...
        /// </summary>
        /// <returns>RepositoryList object</returns>
        public static RepositoryList FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<RepositoryList>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>RepositoryList object</returns>
        public RepositoryList DuplicateRepositoryList()
        {
        ...
        {
            return this.Equals(input as RepositoryList);
        }

        /// <summary>
        /// Returns true if RepositoryList instances are equal
        /// </summary>
        /// <param name="input">Instance of RepositoryList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RepositoryList input)
        {
            if (input == null)
                return false;
            return 
