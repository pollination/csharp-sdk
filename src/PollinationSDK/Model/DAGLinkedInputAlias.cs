...
namespace PollinationSDK.Model
{
    ...
    public partial class DAGLinkedInputAlias :  IEquatable<DAGLinkedInputAlias>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            if (handler == null)
            {
                throw new InvalidDataException("handler is a required property for DAGLinkedInputAlias and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGLinkedInputAlias and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (platform == null)
            {
                throw new InvalidDataException("platform is a required property for DAGLinkedInputAlias and cannot be null");
            }
            else
            {
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGLinkedInputAlias>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>DAGLinkedInputAlias object</returns>
        public DAGLinkedInputAlias DuplicateDAGLinkedInputAlias()
        {
