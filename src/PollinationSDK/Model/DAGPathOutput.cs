...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DAGPathOutput :  IEquatable<DAGPathOutput>, IValidatableObject
    {
        /// <summary>
        ...
        (
           AnyOf<TaskReference,FileReference,FolderReference> from, string name, // Required parameters
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGPathOutput and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGPathOutput>(json, JsonSetting.ConvertSetting);
            return obj;
        }
