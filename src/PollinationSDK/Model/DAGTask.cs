...
namespace PollinationSDK.Model
{
    ...
    public partial class DAGTask : OpenAPIGenBaseModel,  IEquatable<DAGTask>, IValidatableObject
    {
        ...
        public DAGTask(string name = default(string), string template = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), List<string> needs = default(List<string>), List<AnyOf<TaskArgument,TaskPathArgument>> arguments = default(List<AnyOf<TaskArgument,TaskPathArgument>>), DAGTaskLoop loop = default(DAGTaskLoop), string subFolder = default(string), List<AnyOf<TaskReturn,TaskPathReturn>> returns = default(List<AnyOf<TaskReturn,TaskPathReturn>>)) : base()
        {
