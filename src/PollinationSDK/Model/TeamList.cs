...
namespace PollinationSDK.Model
{
    ...
    public partial class TeamList : OpenAPIGenBaseModel,  IEquatable<TeamList>, IValidatableObject
    {
        /// <summary>
        ...
        public TeamList(int page = default(int), int perPage = default(int), int pageCount = default(int), int totalCount = default(int), List<Team> resources = default(List<Team>), int nextPage = default(int)) : base()
        {
            // to ensure "page" is required (not null)
            if (page == null)
            {
                throw new InvalidDataException("page is a required property for TeamList and cannot be null");
            }
            else
            {
                this.Page = page;
            ...
            if (perPage == null)
            {
                throw new InvalidDataException("perPage is a required property for TeamList and cannot be null");
            }
            else
            {
            ...
            if (pageCount == null)
            {
                throw new InvalidDataException("pageCount is a required property for TeamList and cannot be null");
            }
            else
            {
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for TeamList and cannot be null");
            }
            else
            {
            ...
            if (resources == null)
            {
                throw new InvalidDataException("resources is a required property for TeamList and cannot be null");
            }
            else
            {
        ...
        public List<Team> Resources { get; set; }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^TeamList$", RegexOptions.CultureInvariant);
