...
namespace PollinationSDK
{
    ...
    public partial class TeamList : OpenAPIGenBaseModel, IEquatable<TeamList>, IValidatableObject
    {
        ...
        public TeamList
        (
           int page, int perPage, int pageCount, int totalCount, List<Team> resources, // Required parameters
        ...
        ) : base()// BaseClass
        {
            ...
            this.Resources = resources ?? throw new ArgumentNullException("resources is a required property for TeamList and cannot be null");
        ...
        public override string Type { get; protected internal set; }  = "TeamList";
        ...
        {
            var obj = JsonConvert.DeserializeObject<TeamList>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>TeamList object</returns>
        public virtual TeamList DuplicateTeamList()
        {
