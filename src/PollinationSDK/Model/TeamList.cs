...
namespace PollinationSDK.Model
{
    ...
    public partial class TeamList :  IEquatable<TeamList>, IValidatableObject
    {
        ...
        public TeamList
        (
           int page, int pageCount, int perPage, List<Team> resources, int totalCount, // Required parameters
        ...
        /// </summary>
        /// <returns>TeamList object</returns>
        public static TeamList FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<TeamList>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>TeamList object</returns>
        public TeamList DuplicateTeamList()
        {
