...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DAGBooleanOutputAlias :  IEquatable<DAGBooleanOutputAlias>, IValidatableObject
    {
        /// <summary>
        ...
        )// BaseClass
        {
            ...
            if (from == null)
            {
                throw new InvalidDataException("from is a required property for DAGBooleanOutputAlias and cannot be null");
            }
            else
            {
                this.From = from;
            ...
            if (handler == null)
            {
                throw new InvalidDataException("handler is a required property for DAGBooleanOutputAlias and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGBooleanOutputAlias and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (platform == null)
            {
                throw new InvalidDataException("platform is a required property for DAGBooleanOutputAlias and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DAGBooleanOutputAlias {\n");
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGBooleanOutputAlias>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>DAGBooleanOutputAlias object</returns>
        public DAGBooleanOutputAlias DuplicateDAGBooleanOutputAlias()
        {
