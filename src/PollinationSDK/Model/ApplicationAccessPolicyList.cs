...
namespace PollinationSDK
{
    ...
    /// </summary>
    [DataContract(Name = "ApplicationAccessPolicyList")]
    public partial class ApplicationAccessPolicyList : OpenAPIGenBaseModel, IEquatable<ApplicationAccessPolicyList>, IValidatableObject
    {
        /// <summary>
        ...
        { 
            ...
            this.Type = "ApplicationAccessPolicyList";
        }
        ...
        (
           int page, int perPage, int pageCount, int totalCount, List<ApplicationAccessPolicy> resources, // Required parameters
        ...
        ) : base()// BaseClass
        {
            ...
            this.Resources = resources ?? throw new ArgumentNullException("resources is a required property for ApplicationAccessPolicyList and cannot be null");
        ...
        public override string Type { get; protected set; }  = "ApplicationAccessPolicyList";
        ...
        public override string ToString(bool detailed)
        {
            ...
            sb.Append("ApplicationAccessPolicyList:\n");
        ...
        {
            var obj = JsonConvert.DeserializeObject<ApplicationAccessPolicyList>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>ApplicationAccessPolicyList object</returns>
        public virtual ApplicationAccessPolicyList DuplicateApplicationAccessPolicyList()
        {
        ...
        {
            return DuplicateApplicationAccessPolicyList();
        }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^ApplicationAccessPolicyList$", RegexOptions.CultureInvariant);
