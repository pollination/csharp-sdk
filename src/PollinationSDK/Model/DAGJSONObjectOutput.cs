...
namespace PollinationSDK.Model
{
    ...
    public partial class DAGJSONObjectOutput : GenericOutput,  IEquatable<DAGJSONObjectOutput>, IValidatableObject
    {
        ...
        public DAGJSONObjectOutput(AnyOf<TaskReference,FileReference> from = default(AnyOf<TaskReference,FileReference>), List<AnyOf<DAGGenericOutputAlias,DAGStringOutputAlias,DAGIntegerOutputAlias,DAGNumberOutputAlias,DAGBooleanOutputAlias,DAGFolderOutputAlias,DAGFileOutputAlias,DAGPathOutputAlias,DAGArrayOutputAlias,DAGJSONObjectOutputAlias,DAGLinkedOutputAlias>> alias = default(List<AnyOf<DAGGenericOutputAlias,DAGStringOutputAlias,DAGIntegerOutputAlias,DAGNumberOutputAlias,DAGBooleanOutputAlias,DAGFolderOutputAlias,DAGFileOutputAlias,DAGPathOutputAlias,DAGArrayOutputAlias,DAGJSONObjectOutputAlias,DAGLinkedOutputAlias>>), bool required = true, string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string)) : base(name, annotations, description)
        {
            // to ensure "from" is required (not null)
            if (from == null)
            {
                throw new InvalidDataException("from is a required property for DAGJSONObjectOutput and cannot be null");
            }
            else
            {
                this.From = from;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DAGJSONObjectOutput {\n");
