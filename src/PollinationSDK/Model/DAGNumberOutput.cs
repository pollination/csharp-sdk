...
namespace PollinationSDK.Model
{
    ...
    public partial class DAGNumberOutput :  IEquatable<DAGNumberOutput>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGNumberOutput and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGNumberOutput>(json, JsonSetting.ConvertSetting);
            return obj;
        }
