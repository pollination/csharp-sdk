...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DAGPathOutputAlias :  IEquatable<DAGPathOutputAlias>, IValidatableObject
    {
        /// <summary>
        ...
        (
           AnyOf<TaskReference,FileReference,FolderReference> from, List<IOAliasHandler> handler, string name, List<string> platform, // Required parameters
        ...
        )// BaseClass
        {
            ...
            if (handler == null)
            {
                throw new InvalidDataException("handler is a required property for DAGPathOutputAlias and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGPathOutputAlias and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (platform == null)
            {
                throw new InvalidDataException("platform is a required property for DAGPathOutputAlias and cannot be null");
            }
            else
            {
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGPathOutputAlias>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>DAGPathOutputAlias object</returns>
        public DAGPathOutputAlias DuplicateDAGPathOutputAlias()
        {
