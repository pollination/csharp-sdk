...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DAGJSONObjectInput :  IEquatable<DAGJSONObjectInput>, IValidatableObject
    {
        /// <summary>
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGJSONObjectInput and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DAGJSONObjectInput {\n");
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGJSONObjectInput>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>DAGJSONObjectInput object</returns>
        public DAGJSONObjectInput DuplicateDAGJSONObjectInput()
        {
