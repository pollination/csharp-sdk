...
namespace PollinationSDK.Model
{
    ...
    public partial class StepBooleanOutput : FunctionBooleanOutput,  IEquatable<StepBooleanOutput>, IValidatableObject
    {
        ...
        public StepBooleanOutput(bool value = default(bool), string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string), string path = default(string), bool required = true) : base()
        {
