...
namespace PollinationSDK
{
    ...
    public partial class InvoiceList : OpenAPIGenBaseModel, IEquatable<InvoiceList>, IValidatableObject
    {
        /// <summary>
        ...
        public InvoiceList
        (
           List<Invoice> resources, bool hasMore// Required parameters
           // Optional parameters
        ) : base()// BaseClass
        {
        ...
        public override string Type { get; protected internal set; }  = "InvoiceList";
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^InvoiceList$", RegexOptions.CultureInvariant);
