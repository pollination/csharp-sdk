...
namespace PollinationSDK.Model
{
    ...
    public partial class StepStringOutput : FunctionStringOutput,  IEquatable<StepStringOutput>, IValidatableObject
    {
        ...
        public StepStringOutput(string value = default(string), string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string), string path = default(string), bool required = true) : base()
        {
