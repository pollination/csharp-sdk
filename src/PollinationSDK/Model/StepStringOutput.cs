...
namespace PollinationSDK
{
    ...
    public partial class StepStringOutput : IEquatable<StepStringOutput>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for StepStringOutput and cannot be null");
            // to ensure "path" is required (not null)
            this.Path = path ?? throw new ArgumentNullException("path is a required property for StepStringOutput and cannot be null");
