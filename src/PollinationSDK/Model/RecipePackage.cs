...
namespace PollinationSDK.Model
{
    ...
    public partial class RecipePackage : RepositoryPackage,  IEquatable<RecipePackage>, IValidatableObject
    {
        ...
        public RecipePackage(RecipeInterface manifest = default(RecipeInterface), string digest = default(string), string tag = default(string), List<string> keywords = default(List<string>), string description = default(string), string icon = default(string), DateTime createdAt = default(DateTime), string readme = default(string)) : base(digest, tag, keywords, description, icon, createdAt, readme)
        {
