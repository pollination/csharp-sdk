...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InputPathReference :  IEquatable<InputPathReference>, IValidatableObject
    {
        /// <summary>
        ...
        )// BaseClass
        {
            ...
            if (variable == null)
            {
                throw new InvalidDataException("variable is a required property for InputPathReference and cannot be null");
            }
            else
            {
        ...
        {
            var obj = JsonConvert.DeserializeObject<InputPathReference>(json, JsonSetting.ConvertSetting);
            return obj;
        }
