...
namespace PollinationSDK.Model
{
    ...
    public partial class OrganizationCreate : OrganizationUpdate,  IEquatable<OrganizationCreate>, IValidatableObject
    {
        ...
        /// </summary>
        public OrganizationCreate(string accountName = default(string), string name = default(string), string pictureUrl = default(string), string contactEmail = default(string), string description = default(string)) : base(accountName, name, pictureUrl, contactEmail, description)
        {
        }
