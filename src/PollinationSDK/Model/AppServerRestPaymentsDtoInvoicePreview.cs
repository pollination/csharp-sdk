...
{
    /// <summary>
    /// AppServerRestPaymentsDtoInvoicePreview
    /// </summary>
    [DataContract]
    public partial class AppServerRestPaymentsDtoInvoicePreview :  IEquatable<AppServerRestPaymentsDtoInvoicePreview>, IValidatableObject
    {
        /// <summary>
        /// Gets or Sets Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AppServerRestPaymentsDtoInvoicePreview" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AppServerRestPaymentsDtoInvoicePreview() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AppServerRestPaymentsDtoInvoicePreview" /> class.
        /// </summary>
        ...
        public AppServerRestPaymentsDtoInvoicePreview
        (
           ...
           bool autoAdvance= default, string description= default, string hostedInvoiceUrl= default, CardPublic paymentMethod= default, string subscription= default // Optional parameters
        )// BaseClass
        {
            // to ensure "collectionMethod" is required (not null)
            if (collectionMethod == null)
            {
                throw new InvalidDataException("collectionMethod is a required property for AppServerRestPaymentsDtoInvoicePreview and cannot be null");
            }
            else
            {
            ...
            if (currency == null)
            {
                throw new InvalidDataException("currency is a required property for AppServerRestPaymentsDtoInvoicePreview and cannot be null");
            }
            else
            {
            ...
            if (customer == null)
            {
                throw new InvalidDataException("customer is a required property for AppServerRestPaymentsDtoInvoicePreview and cannot be null");
            }
            else
            {
            ...
            if (lines == null)
            {
                throw new InvalidDataException("lines is a required property for AppServerRestPaymentsDtoInvoicePreview and cannot be null");
            }
            else
            {
                this.Lines = lines;
            ...
            if (periodEnd == null)
            {
                throw new InvalidDataException("periodEnd is a required property for AppServerRestPaymentsDtoInvoicePreview and cannot be null");
            }
            else
            {
            ...
            if (periodStart == null)
            {
                throw new InvalidDataException("periodStart is a required property for AppServerRestPaymentsDtoInvoicePreview and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for AppServerRestPaymentsDtoInvoicePreview and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            {
                throw new InvalidDataException("statusTransitions is a required property for AppServerRestPaymentsDtoInvoicePreview and cannot be null");
            }
            else
            {
            ...
            if (total == null)
            {
                throw new InvalidDataException("total is a required property for AppServerRestPaymentsDtoInvoicePreview and cannot be null");
            }
            else
            {
                this.Total = total;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppServerRestPaymentsDtoInvoicePreview {\n");
        ...
        /// </summary>
        /// <returns>AppServerRestPaymentsDtoInvoicePreview object</returns>
        public static AppServerRestPaymentsDtoInvoicePreview FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<AppServerRestPaymentsDtoInvoicePreview>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>AppServerRestPaymentsDtoInvoicePreview object</returns>
        public AppServerRestPaymentsDtoInvoicePreview DuplicateAppServerRestPaymentsDtoInvoicePreview()
        {
        ...
        {
            return this.Equals(input as AppServerRestPaymentsDtoInvoicePreview);
        }

        /// <summary>
        /// Returns true if AppServerRestPaymentsDtoInvoicePreview instances are equal
        /// </summary>
        /// <param name="input">Instance of AppServerRestPaymentsDtoInvoicePreview to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppServerRestPaymentsDtoInvoicePreview input)
        {
            if (input == null)
                return false;
            return 
