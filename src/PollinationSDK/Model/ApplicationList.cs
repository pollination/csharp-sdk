...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ApplicationList :  IEquatable<ApplicationList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApplicationList" /> class.
        /// </summary>
        ...
        (
           int page, int pageCount, int perPage, List<Application> resources, int totalCount, // Required parameters
        ...
        )// BaseClass
        {
            ...
            if (page == null)
            {
                throw new InvalidDataException("page is a required property for ApplicationList and cannot be null");
            }
            else
            {
                this.Page = page;
            ...
            if (pageCount == null)
            {
                throw new InvalidDataException("pageCount is a required property for ApplicationList and cannot be null");
            }
            else
            {
            ...
            if (perPage == null)
            {
                throw new InvalidDataException("perPage is a required property for ApplicationList and cannot be null");
            }
            else
            {
            ...
            if (resources == null)
            {
                throw new InvalidDataException("resources is a required property for ApplicationList and cannot be null");
            }
            else
            {
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for ApplicationList and cannot be null");
            }
            else
            {
        ...
        public List<Application> Resources { get; set; } 
        /// <summary>
        ...
        /// </summary>
        /// <returns>ApplicationList object</returns>
        public static ApplicationList FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<ApplicationList>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>ApplicationList object</returns>
        public ApplicationList DuplicateApplicationList()
        {
        ...
        {
            return this.Equals(input as ApplicationList);
        }

        /// <summary>
        /// Returns true if ApplicationList instances are equal
        /// </summary>
        /// <param name="input">Instance of ApplicationList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApplicationList input)
        {
            if (input == null)
                return false;
            return 
