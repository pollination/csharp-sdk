...
namespace PollinationSDK
{
    ...
    /// </summary>
    [DataContract(Name = "ApplicationList")]
    public partial class ApplicationList : OpenAPIGenBaseModel, IEquatable<ApplicationList>, IValidatableObject
    {
        /// <summary>
        ...
        (
           int page, int perPage, int pageCount, int totalCount, List<Application> resources, // Required parameters
        ...
        ) : base()// BaseClass
        {
            ...
            this.Resources = resources ?? throw new ArgumentNullException("resources is a required property for ApplicationList and cannot be null");
        ...
        public override string Type { get; protected set; }  = "ApplicationList";
        ...
        {
            var obj = JsonConvert.DeserializeObject<ApplicationList>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>ApplicationList object</returns>
        public virtual ApplicationList DuplicateApplicationList()
        {
        ...
        {
            return DuplicateApplicationList();
        }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^ApplicationList$", RegexOptions.CultureInvariant);
