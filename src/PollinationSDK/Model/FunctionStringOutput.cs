...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FunctionStringOutput :  IEquatable<FunctionStringOutput>, IValidatableObject
    {
        /// <summary>
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for FunctionStringOutput and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (path == null)
            {
                throw new InvalidDataException("path is a required property for FunctionStringOutput and cannot be null");
            }
            else
            {
                this.Path = path;
        ...
        {
            var obj = JsonConvert.DeserializeObject<FunctionStringOutput>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>FunctionStringOutput object</returns>
        public FunctionStringOutput DuplicateFunctionStringOutput()
        {
