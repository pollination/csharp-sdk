...
namespace PollinationSDK.Model
{
    ...
    public partial class OperatorVersion :  IEquatable<OperatorVersion>, IValidatableObject
    {
        ...
        (
           ...
           string appVersion= default, bool deprecated= default, string description= default, string home= default, string icon= default, List<string> keywords= default, List<QueenbeeOperatorMetadataMaintainer> maintainers= default, List<string> sources= default // Optional parameters
        )// BaseClass
        {
            // to ensure "created" is required (not null)
            if (created == null)
            {
                throw new InvalidDataException("created is a required property for OperatorVersion and cannot be null");
            }
            else
            {
            ...
            if (digest == null)
            {
                throw new InvalidDataException("digest is a required property for OperatorVersion and cannot be null");
            }
            else
            {
                this.Digest = digest;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for OperatorVersion and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (tag == null)
            {
                throw new InvalidDataException("tag is a required property for OperatorVersion and cannot be null");
            }
            else
            {
                this.Tag = tag;
            ...
            if (url == null)
            {
                throw new InvalidDataException("url is a required property for OperatorVersion and cannot be null");
            }
            else
            {
                this.Url = url;
        ...
        {
            var obj = JsonConvert.DeserializeObject<OperatorVersion>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        {
            return this.Equals(input as OperatorVersion);
        }

        /// <summary>
        /// Returns true if OperatorVersion instances are equal
        /// </summary>
        /// <param name="input">Instance of OperatorVersion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OperatorVersion input)
        {
            if (input == null)
                return false;
            return 
