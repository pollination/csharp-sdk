...
namespace PollinationSDK
{
    ...
    /// </summary>
    [DataContract(Name = "AccessPolicyList")]
    public partial class AccessPolicyList : OpenAPIGenBaseModel, IEquatable<AccessPolicyList>, IValidatableObject
    {
        ...
        (
           int page, int perPage, int pageCount, int totalCount, List<AccessPolicy> resources, // Required parameters
        ...
        ) : base()// BaseClass
        {
            ...
            this.Resources = resources ?? throw new ArgumentNullException("resources is a required property for AccessPolicyList and cannot be null");
        ...
        public override string Type { get; protected set; }  = "AccessPolicyList";
        ...
        /// </summary>
        /// <returns>AccessPolicyList object</returns>
        public static AccessPolicyList FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<AccessPolicyList>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>AccessPolicyList object</returns>
        public virtual AccessPolicyList DuplicateAccessPolicyList()
        {
        ...
        {
            return DuplicateAccessPolicyList();
        }
