...
namespace PollinationSDK.Model
{
    ...
    public partial class JobPathArgument : OpenAPIGenBaseModel,  IEquatable<JobPathArgument>, IValidatableObject
    {
        ...
        public JobPathArgument(string name = default(string), AnyOf<HTTP,S3,ProjectFolder> source = default(AnyOf<HTTP,S3,ProjectFolder>), Dictionary<string, string> annotations = default(Dictionary<string, string>)) : base()
        {
