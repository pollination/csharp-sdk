...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentMethodList :  IEquatable<PaymentMethodList>, IValidatableObject
    {
        /// <summary>
        ...
        (
           int page, int pageCount, int perPage, List<CardPublic> resources, int totalCount, // Required parameters
        ...
        )// BaseClass
        {
            ...
            if (page == null)
            {
                throw new InvalidDataException("page is a required property for PaymentMethodList and cannot be null");
            }
            else
            {
                this.Page = page;
            ...
            if (pageCount == null)
            {
                throw new InvalidDataException("pageCount is a required property for PaymentMethodList and cannot be null");
            }
            else
            {
            ...
            if (perPage == null)
            {
                throw new InvalidDataException("perPage is a required property for PaymentMethodList and cannot be null");
            }
            else
            {
            ...
            if (resources == null)
            {
                throw new InvalidDataException("resources is a required property for PaymentMethodList and cannot be null");
            }
            else
            {
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for PaymentMethodList and cannot be null");
            }
            else
            {
        ...
        public List<CardPublic> Resources { get; set; } 
        /// <summary>
        ...
        /// </summary>
        /// <returns>PaymentMethodList object</returns>
        public static PaymentMethodList FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<PaymentMethodList>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>PaymentMethodList object</returns>
        public PaymentMethodList DuplicatePaymentMethodList()
        {
