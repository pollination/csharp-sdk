...
namespace PollinationSDK
{
    ...
    public partial class PaymentMethodList : OpenAPIGenBaseModel, IEquatable<PaymentMethodList>, IValidatableObject
    {
        /// <summary>
        ...
        (
           int page, int perPage, int pageCount, int totalCount, List<CardPublic> resources, // Required parameters
        ...
        ) : base()// BaseClass
        {
            ...
            this.Resources = resources ?? throw new ArgumentNullException("resources is a required property for PaymentMethodList and cannot be null");
        ...
        public override string Type { get; protected internal set; }  = "PaymentMethodList";
        ...
        {
            var obj = JsonConvert.DeserializeObject<PaymentMethodList>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>PaymentMethodList object</returns>
        public virtual PaymentMethodList DuplicatePaymentMethodList()
        {
        ...
        {
            return DuplicatePaymentMethodList();
        }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^PaymentMethodList$", RegexOptions.CultureInvariant);
