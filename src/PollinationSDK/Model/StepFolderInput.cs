...
namespace PollinationSDK.Model
{
    ...
    public partial class StepFolderInput :  IEquatable<StepFolderInput>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for StepFolderInput and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            var obj = JsonConvert.DeserializeObject<StepFolderInput>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>StepFolderInput object</returns>
        public StepFolderInput DuplicateStepFolderInput()
        {
