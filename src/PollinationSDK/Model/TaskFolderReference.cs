...
namespace PollinationSDK
{
    ...
    public partial class TaskFolderReference : IEquatable<TaskFolderReference>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for TaskFolderReference and cannot be null");
            // to ensure "variable" is required (not null)
            this.Variable = variable ?? throw new ArgumentNullException("variable is a required property for TaskFolderReference and cannot be null");
