...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DAGStringOutput :  IEquatable<DAGStringOutput>, IValidatableObject
    {
        /// <summary>
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGStringOutput and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGStringOutput>(json, JsonSetting.ConvertSetting);
            return obj;
        }
