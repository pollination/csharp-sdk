...
namespace PollinationSDK.Model
{
    ...
    public partial class DAGArtifactOutput : DAGGenericOutput,  IEquatable<DAGArtifactOutput>, IValidatableObject
    {
        ...
        public DAGArtifactOutput(bool required = true, string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string), object from = default(object), List<AnyOf<DAGGenericOutputAlias,DAGStringOutputAlias,DAGIntegerOutputAlias,DAGNumberOutputAlias,DAGBooleanOutputAlias,DAGFolderOutputAlias,DAGFileOutputAlias,DAGPathOutputAlias,DAGArrayOutputAlias,DAGJSONObjectOutputAlias,DAGLinkedOutputAlias>> alias = default(List<AnyOf<DAGGenericOutputAlias,DAGStringOutputAlias,DAGIntegerOutputAlias,DAGNumberOutputAlias,DAGBooleanOutputAlias,DAGFolderOutputAlias,DAGFileOutputAlias,DAGPathOutputAlias,DAGArrayOutputAlias,DAGJSONObjectOutputAlias,DAGLinkedOutputAlias>>)) : base(alias)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DAGArtifactOutput {\n");
