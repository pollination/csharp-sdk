...
namespace PollinationSDK.Model
{
    ...
    public partial class TaskPathReference :  IEquatable<TaskPathReference>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for TaskPathReference and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (variable == null)
            {
                throw new InvalidDataException("variable is a required property for TaskPathReference and cannot be null");
            }
            else
            {
        ...
        {
            var obj = JsonConvert.DeserializeObject<TaskPathReference>(json, JsonSetting.ConvertSetting);
            return obj;
        }
