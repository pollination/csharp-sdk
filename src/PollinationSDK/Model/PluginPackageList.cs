...
namespace PollinationSDK
{
    ...
    /// </summary>
    [DataContract(Name = "PluginPackageList")]
    public partial class PluginPackageList : OpenAPIGenBaseModel, IEquatable<PluginPackageList>, IValidatableObject
    {
        ...
        (
           int page, int perPage, int pageCount, int totalCount, List<PluginPackage> resources, // Required parameters
        ...
        ) : base()// BaseClass
        {
            ...
            this.Resources = resources ?? throw new ArgumentNullException("resources is a required property for PluginPackageList and cannot be null");
        ...
        public override string Type { get; protected internal set; }  = "PluginPackageList";
        ...
        {
            var obj = JsonConvert.DeserializeObject<PluginPackageList>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>PluginPackageList object</returns>
        public virtual PluginPackageList DuplicatePluginPackageList()
        {
        ...
        {
            return DuplicatePluginPackageList();
        }
