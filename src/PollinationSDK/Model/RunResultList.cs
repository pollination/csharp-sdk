...
namespace PollinationSDK
{
    ...
    /// </summary>
    [DataContract(Name = "RunResultList")]
    public partial class RunResultList : OpenAPIGenBaseModel, IEquatable<RunResultList>, IValidatableObject
    {
        ...
        ) : base()// BaseClass
        {
            ...
            this.Resources = resources ?? throw new ArgumentNullException("resources is a required property for RunResultList and cannot be null");
        ...
        public override string Type { get; protected internal set; }  = "RunResultList";
        ...
        {
            var obj = JsonConvert.DeserializeObject<RunResultList>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>RunResultList object</returns>
        public virtual RunResultList DuplicateRunResultList()
        {
