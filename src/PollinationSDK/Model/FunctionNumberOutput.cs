...
namespace PollinationSDK
{
    ...
    public partial class FunctionNumberOutput : IEquatable<FunctionNumberOutput>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for FunctionNumberOutput and cannot be null");
            // to ensure "path" is required (not null)
            this.Path = path ?? throw new ArgumentNullException("path is a required property for FunctionNumberOutput and cannot be null");
        ...
        public string Type { get; protected internal set; }  = "FunctionNumberOutput";
