...
namespace PollinationSDK.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(StepNumberOutput), "StepNumberOutput")]
    public partial class FunctionNumberOutput : FunctionStringOutput,  IEquatable<FunctionNumberOutput>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="FunctionNumberOutput" /> class.
        /// </summary>
        public FunctionNumberOutput(string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string), string path = default(string), bool required = true) : base()
        {
        }
