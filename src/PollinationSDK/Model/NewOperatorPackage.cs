...
namespace PollinationSDK.Model
{
    ...
    public partial class NewOperatorPackage :  IEquatable<NewOperatorPackage>, IValidatableObject
    {
        ...
        protected NewOperatorPackage() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="NewOperatorPackage" /> class.
        /// </summary>
        /// <param name="license">The license file to attach to this package (default to &quot;&quot;).</param>
        /// <param name="manifest">The Operator manifest to be created (required).</param>
        ...
        )// BaseClass
        {
            ...
            if (manifest == null)
            {
                throw new InvalidDataException("manifest is a required property for NewOperatorPackage and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>The Operator manifest to be created</value>
        ...
        {
            var obj = JsonConvert.DeserializeObject<NewOperatorPackage>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        {
            return this.Equals(input as NewOperatorPackage);
        }

        /// <summary>
        /// Returns true if NewOperatorPackage instances are equal
        /// </summary>
        /// <param name="input">Instance of NewOperatorPackage to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewOperatorPackage input)
        {
            if (input == null)
                return false;
            return 
