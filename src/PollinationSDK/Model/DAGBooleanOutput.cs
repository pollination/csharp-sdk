...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DAGBooleanOutput :  IEquatable<DAGBooleanOutput>, IValidatableObject
    {
        /// <summary>
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGBooleanOutput and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGBooleanOutput>(json, JsonSetting.ConvertSetting);
            return obj;
        }
