...
{
    /// <summary>
    /// AppServerRestAccountsDtoQuota
    /// </summary>
    [DataContract]
    public partial class AppServerRestAccountsDtoQuota :  IEquatable<AppServerRestAccountsDtoQuota>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AppServerRestAccountsDtoQuota" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AppServerRestAccountsDtoQuota() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AppServerRestAccountsDtoQuota" /> class.
        /// </summary>
        ...
        public AppServerRestAccountsDtoQuota
        (
        ...
        )// BaseClass
        {
            ...
            if (owner == null)
            {
                throw new InvalidDataException("owner is a required property for AppServerRestAccountsDtoQuota and cannot be null");
            }
            else
            {
                this.Owner = owner;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppServerRestAccountsDtoQuota {\n");
        ...
        /// </summary>
        /// <returns>AppServerRestAccountsDtoQuota object</returns>
        public static AppServerRestAccountsDtoQuota FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<AppServerRestAccountsDtoQuota>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>AppServerRestAccountsDtoQuota object</returns>
        public AppServerRestAccountsDtoQuota DuplicateAppServerRestAccountsDtoQuota()
        {
        ...
        {
            return this.Equals(input as AppServerRestAccountsDtoQuota);
        }

        /// <summary>
        /// Returns true if AppServerRestAccountsDtoQuota instances are equal
        /// </summary>
        /// <param name="input">Instance of AppServerRestAccountsDtoQuota to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppServerRestAccountsDtoQuota input)
        {
            if (input == null)
                return false;
            return 
