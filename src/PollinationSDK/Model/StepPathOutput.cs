...
namespace PollinationSDK.Model
{
    ...
    public partial class StepPathOutput : FunctionPathOutput,  IEquatable<StepPathOutput>, IValidatableObject
    {
        ...
        public StepPathOutput(AnyOf<HTTP,S3,ProjectFolder> source = default(AnyOf<HTTP,S3,ProjectFolder>), string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string), string path = default(string), bool required = true) : base()
        {
