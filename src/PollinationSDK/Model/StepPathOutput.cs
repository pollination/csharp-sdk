...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StepPathOutput :  IEquatable<StepPathOutput>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="path">Path to the output file or folder relative to where the function command is executed. (required).</param>
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for StepPathOutput and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (path == null)
            {
                throw new InvalidDataException("path is a required property for StepPathOutput and cannot be null");
            }
            else
            {
                this.Path = path;
            ...
            if (source == null)
            {
                throw new InvalidDataException("source is a required property for StepPathOutput and cannot be null");
            }
            else
            {
                this.Source = source;
        ...
        /// </summary>
        /// <value>Path to the output file or folder relative to where the function command is executed.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StepPathOutput {\n");
        ...
        {
            var obj = JsonConvert.DeserializeObject<StepPathOutput>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>StepPathOutput object</returns>
        public StepPathOutput DuplicateStepPathOutput()
        {
