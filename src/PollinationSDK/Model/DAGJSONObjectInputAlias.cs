...
namespace PollinationSDK.Model
{
    ...
    public partial class DAGJSONObjectInputAlias : GenericInput,  IEquatable<DAGJSONObjectInputAlias>, IValidatableObject
    {
        ...
        public DAGJSONObjectInputAlias(List<string> platform = default(List<string>), List<IOAliasHandler> handler = default(List<IOAliasHandler>), Object _default = default(Object), bool required = false, Object spec = default(Object), string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string)) : base(name, annotations, description)
        {
