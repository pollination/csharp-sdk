...
namespace PollinationSDK.Model
{
    ...
    public partial class ProjectDto :  IEquatable<ProjectDto>, IValidatableObject
    {
        ...
        public ProjectDto
        (
           string id, string name, AccountPublic owner, ProjectPermissions permissions, string slug, // Required parameters
        ...
        {
            var obj = JsonConvert.DeserializeObject<ProjectDto>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>ProjectDto object</returns>
        public ProjectDto DuplicateProjectDto()
        {
