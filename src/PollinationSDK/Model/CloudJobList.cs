...
namespace PollinationSDK
{
    ...
    /// </summary>
    [DataContract(Name = "CloudJobList")]
    public partial class CloudJobList : OpenAPIGenBaseModel, IEquatable<CloudJobList>, IValidatableObject
    {
        ...
        public CloudJobList
        (
           int page, int perPage, int pageCount, int totalCount, List<CloudJob> resources, // Required parameters
        ...
        ) : base()// BaseClass
        {
            ...
            this.Resources = resources ?? throw new ArgumentNullException("resources is a required property for CloudJobList and cannot be null");
        ...
        public override string Type { get; protected set; }  = "CloudJobList";
        ...
        {
            var obj = JsonConvert.DeserializeObject<CloudJobList>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>CloudJobList object</returns>
        public virtual CloudJobList DuplicateCloudJobList()
        {
