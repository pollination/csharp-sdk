...
namespace PollinationSDK.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(DAGLinkedInputAlias), "DAGLinkedInputAlias")]
    public partial class DAGGenericInputAlias : GenericInput,  IEquatable<DAGGenericInputAlias>, IValidatableObject
    {
        ...
        public DAGGenericInputAlias(List<string> platform = default(List<string>), List<IOAliasHandler> handler = default(List<IOAliasHandler>), string _default = default(string), bool required = false, Object spec = default(Object), string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string)) : base(name, annotations, description)
        {
