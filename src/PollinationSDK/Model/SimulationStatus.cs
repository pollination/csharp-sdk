...
namespace PollinationSDK.Model
{
    ...
    public partial class SimulationStatus :  IEquatable<SimulationStatus>, IValidatableObject
    {
        ...
        (
           string id, string ownerId, string projectId, string recipeId, string recipeOwnerId, string recipePackageId, DateTime startedAt, string status, // Required parameters
