...
namespace PollinationSDK.Model
{
    ...
    public partial class Application :  IEquatable<Application>, IValidatableObject
    {
        ...
        (
           ...
           DeploymentConfig deploymentConfig= default, string description = "", string image = "https://picsum.photos/400", bool isPaid = false, List<string> keywords= default, string license= default, bool _public = true, string source= default// Optional parameters
        )// BaseClass
        {
