...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FolderReference :  IEquatable<FolderReference>, IValidatableObject
    {
        /// <summary>
        ...
        {
            var obj = JsonConvert.DeserializeObject<FolderReference>(json, JsonSetting.ConvertSetting);
            return obj;
        }
