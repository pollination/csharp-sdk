...
namespace PollinationSDK.Model
{
    ...
    public partial class JobStatus : OpenAPIGenBaseModel,  IEquatable<JobStatus>, IValidatableObject
    {
        ...
        public JobStatus(string id = default(string), DateTime startedAt = default(DateTime), Dictionary<string, string> annotations = default(Dictionary<string, string>), JobStatusEnum? status = default(JobStatusEnum?), string message = default(string), DateTime finishedAt = default(DateTime), string source = default(string), int runsPending = 0, int runsRunning = 0, int runsCompleted = 0, int runsFailed = 0, int runsCancelled = 0) : base()
        {
        ...
        public int RunsPending { get; set; }
        ...
        public int RunsRunning { get; set; }
