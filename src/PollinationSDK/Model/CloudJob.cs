...
namespace PollinationSDK.Model
{
    ...
    public partial class CloudJob :  IEquatable<CloudJob>, IValidatableObject
    {
        ...
        (
           ...
           AccountPublic author= default, AccountPublic owner= default, RecipeInterface recipe= default, ResourcesDuration resourcesDuration= default, JobStatus status= default// Optional parameters
        )// BaseClass
        {
