...
namespace PollinationSDK.Model
{
    ...
    public partial class FunctionOutputs :  IEquatable<FunctionOutputs>, IValidatableObject
    {
        ...
        (
           // Required parameters
           List<FunctionArtifact> artifacts= default, List<FunctionParameterOut> parameters= default// Optional parameters
        )// BaseClass
        {
        ...
        {
            var obj = JsonConvert.DeserializeObject<FunctionOutputs>(json, JsonSetting.ConvertSetting);
            return obj;
        }
