...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DAGPathInput :  IEquatable<DAGPathInput>, IValidatableObject
    {
        /// <summary>
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGPathInput>(json, JsonSetting.ConvertSetting);
            return obj;
        }
