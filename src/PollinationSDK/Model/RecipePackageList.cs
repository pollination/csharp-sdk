...
namespace PollinationSDK.Model
{
    ...
    public partial class RecipePackageList : OpenAPIGenBaseModel,  IEquatable<RecipePackageList>, IValidatableObject
    {
        ...
        public RecipePackageList(int page = default(int), int perPage = default(int), int pageCount = default(int), int totalCount = default(int), List<RecipePackage> resources = default(List<RecipePackage>), int nextPage = default(int)) : base()
        {
