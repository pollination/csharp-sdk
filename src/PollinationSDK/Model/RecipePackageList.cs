...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecipePackageList :  IEquatable<RecipePackageList>, IValidatableObject
    {
        /// <summary>
        ...
        (
           int page, int pageCount, int perPage, List<RecipePackage> resources, int totalCount, // Required parameters
        ...
        )// BaseClass
        {
            ...
            if (page == null)
            {
                throw new InvalidDataException("page is a required property for RecipePackageList and cannot be null");
            }
            else
            {
                this.Page = page;
            ...
            if (pageCount == null)
            {
                throw new InvalidDataException("pageCount is a required property for RecipePackageList and cannot be null");
            }
            else
            {
            ...
            if (perPage == null)
            {
                throw new InvalidDataException("perPage is a required property for RecipePackageList and cannot be null");
            }
            else
            {
            ...
            if (resources == null)
            {
                throw new InvalidDataException("resources is a required property for RecipePackageList and cannot be null");
            }
            else
            {
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for RecipePackageList and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecipePackageList {\n");
        ...
        {
            var obj = JsonConvert.DeserializeObject<RecipePackageList>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>RecipePackageList object</returns>
        public RecipePackageList DuplicateRecipePackageList()
        {
