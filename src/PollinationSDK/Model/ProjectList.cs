...
namespace PollinationSDK
{
    ...
    public partial class ProjectList : OpenAPIGenBaseModel, IEquatable<ProjectList>, IValidatableObject
    {
        ...
        public ProjectList
        (
           int page, int perPage, int pageCount, int totalCount, List<Project> resources, // Required parameters
        ...
        ) : base()// BaseClass
        {
            ...
            this.Resources = resources ?? throw new ArgumentNullException("resources is a required property for ProjectList and cannot be null");
        ...
        public override string Type { get; protected internal set; }  = "ProjectList";
        ...
        {
            var obj = JsonConvert.DeserializeObject<ProjectList>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>ProjectList object</returns>
        public virtual ProjectList DuplicateProjectList()
        {
