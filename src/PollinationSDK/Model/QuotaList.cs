...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class QuotaList :  IEquatable<QuotaList>, IValidatableObject
    {
        /// <summary>
        ...
        public QuotaList
        (
           int page, int pageCount, int perPage, List<AppServerRestAccountsDtoQuota> resources, int totalCount, // Required parameters
        ...
        )// BaseClass
        {
            ...
            if (page == null)
            {
                throw new InvalidDataException("page is a required property for QuotaList and cannot be null");
            }
            else
            {
                this.Page = page;
            ...
            if (pageCount == null)
            {
                throw new InvalidDataException("pageCount is a required property for QuotaList and cannot be null");
            }
            else
            {
            ...
            if (perPage == null)
            {
                throw new InvalidDataException("perPage is a required property for QuotaList and cannot be null");
            }
            else
            {
            ...
            if (resources == null)
            {
                throw new InvalidDataException("resources is a required property for QuotaList and cannot be null");
            }
            else
            {
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for QuotaList and cannot be null");
            }
            else
            {
        ...
        public List<AppServerRestAccountsDtoQuota> Resources { get; set; } 
        /// <summary>
        ...
        {
            var obj = JsonConvert.DeserializeObject<QuotaList>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>QuotaList object</returns>
        public QuotaList DuplicateQuotaList()
        {
