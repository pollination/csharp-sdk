...
namespace PollinationSDK.Model
{
    ...
    public partial class QuotaList : OpenAPIGenBaseModel,  IEquatable<QuotaList>, IValidatableObject
    {
        ...
        public QuotaList(int page = default(int), int perPage = default(int), int pageCount = default(int), int totalCount = default(int), List<Quota> resources = default(List<Quota>), int nextPage = default(int)) : base()
        {
