...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DAGFolderOutput :  IEquatable<DAGFolderOutput>, IValidatableObject
    {
        /// <summary>
        ...
        (
           AnyOf<TaskReference,FolderReference> from, string name, // Required parameters
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGFolderOutput and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGFolderOutput>(json, JsonSetting.ConvertSetting);
            return obj;
        }
