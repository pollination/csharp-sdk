...
namespace PollinationSDK.Model
{
    ...
    public partial class DAGIntegerInputAlias : GenericInput,  IEquatable<DAGIntegerInputAlias>, IValidatableObject
    {
        ...
        public DAGIntegerInputAlias(List<string> platform = default(List<string>), List<IOAliasHandler> handler = default(List<IOAliasHandler>), int _default = default(int), bool required = false, Object spec = default(Object), string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string)) : base(name, annotations, description)
        {
