...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DAGIntegerInputAlias :  IEquatable<DAGIntegerInputAlias>, IValidatableObject
    {
        /// <summary>
        ...
        (
           ...
           Dictionary<string, string> annotations= default, int _default= default, string description= default, bool required = false, Object spec= default // Optional parameters
        )// BaseClass
        {
            // to ensure "handler" is required (not null)
            if (handler == null)
            {
                throw new InvalidDataException("handler is a required property for DAGIntegerInputAlias and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGIntegerInputAlias and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (platform == null)
            {
                throw new InvalidDataException("platform is a required property for DAGIntegerInputAlias and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DAGIntegerInputAlias {\n");
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGIntegerInputAlias>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>DAGIntegerInputAlias object</returns>
        public DAGIntegerInputAlias DuplicateDAGIntegerInputAlias()
        {
