...
namespace PollinationSDK.Model
{
    ...
    public partial class TaskFileReference :  IEquatable<TaskFileReference>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for TaskFileReference and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (variable == null)
            {
                throw new InvalidDataException("variable is a required property for TaskFileReference and cannot be null");
            }
            else
            {
        ...
        {
            var obj = JsonConvert.DeserializeObject<TaskFileReference>(json, JsonSetting.ConvertSetting);
            return obj;
        }
