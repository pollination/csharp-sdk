...
namespace PollinationSDK.Model
{
    ...
    public partial class DeploymentConfig :  IEquatable<DeploymentConfig>, IValidatableObject
    {
        ...
        (
           // Required parameters
           int cpuLimit = 1, string entrypointFile = "app.py", bool loginRequired = true, int memoryLimit = 2000, bool scaleToZero = true// Optional parameters
        )// BaseClass
        {
            ...
            // use default value if no "scaleToZero" provided
            if (scaleToZero == null)
            {
