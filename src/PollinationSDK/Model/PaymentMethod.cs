...
namespace PollinationSDK.Model
{
    ...
    public partial class PaymentMethod :  IEquatable<PaymentMethod>, IValidatableObject
    {
        ...
        /// <param name="lastFourDigits">lastFourDigits (required).</param>
        /// <param name="paymentMethod">paymentMethod (required).</param>
        public PaymentMethod
        (
           CardType cardType, string expiryDate, string lastFourDigits, PaymentMethodEnum paymentMethod// Required parameters
           // Optional parameters
        )// BaseClass
        {
            ...
            // to ensure "lastFourDigits" is required (not null)
            if (lastFourDigits == null)
            {
                throw new InvalidDataException("lastFourDigits is a required property for PaymentMethod and cannot be null");
            }
            else
            {
