...
namespace PollinationSDK.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(DAGLinkedOutputAlias), "DAGLinkedOutputAlias")]
    [JsonSubtypes.KnownSubType(typeof(DAGArtifactOutputAlias), "_DAGArtifactOutputAlias")]
    public partial class DAGGenericOutputAlias : GenericOutput,  IEquatable<DAGGenericOutputAlias>, IValidatableObject
    {
        ...
        public DAGGenericOutputAlias(List<string> platform = default(List<string>), List<IOAliasHandler> handler = default(List<IOAliasHandler>), string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string)) : base(name, annotations, description)
        {
