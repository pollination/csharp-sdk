...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DAGIntegerOutput :  IEquatable<DAGIntegerOutput>, IValidatableObject
    {
        /// <summary>
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGIntegerOutput and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGIntegerOutput>(json, JsonSetting.ConvertSetting);
            return obj;
        }
