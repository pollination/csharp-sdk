...
namespace PollinationSDK
{
    ...
    /// </summary>
    [DataContract(Name = "PublicAccountList")]
    public partial class PublicAccountList : OpenAPIGenBaseModel, IEquatable<PublicAccountList>, IValidatableObject
    {
        ...
        (
           int page, int perPage, int pageCount, int totalCount, List<AccountPublic> resources, // Required parameters
        ...
        ) : base()// BaseClass
        {
            ...
            this.Resources = resources ?? throw new ArgumentNullException("resources is a required property for PublicAccountList and cannot be null");
        ...
        public override string Type { get; protected internal set; }  = "PublicAccountList";
        ...
        {
            var obj = JsonConvert.DeserializeObject<PublicAccountList>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>PublicAccountList object</returns>
        public virtual PublicAccountList DuplicatePublicAccountList()
        {
        ...
        {
            return DuplicatePublicAccountList();
        }
