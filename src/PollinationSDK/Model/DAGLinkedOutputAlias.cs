...
namespace PollinationSDK.Model
{
    ...
    public partial class DAGLinkedOutputAlias : DAGGenericOutputAlias,  IEquatable<DAGLinkedOutputAlias>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="DAGLinkedOutputAlias" /> class.
        /// </summary>
        public DAGLinkedOutputAlias(string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string), List<string> platform = default(List<string>), List<IOAliasHandler> handler = default(List<IOAliasHandler>)) : base(platform, handler)
        {
        }
