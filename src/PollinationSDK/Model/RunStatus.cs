...
namespace PollinationSDK.Model
{
    ...
    public partial class RunStatus : OpenAPIGenBaseModel,  IEquatable<RunStatus>, IValidatableObject
    {
        ...
        public RunStatus(List<AnyOf<StepStringInput,StepIntegerInput,StepNumberInput,StepBooleanInput,StepFolderInput,StepFileInput,StepPathInput,StepArrayInput,StepJSONObjectInput>> inputs = default(List<AnyOf<StepStringInput,StepIntegerInput,StepNumberInput,StepBooleanInput,StepFolderInput,StepFileInput,StepPathInput,StepArrayInput,StepJSONObjectInput>>), List<AnyOf<StepStringOutput,StepIntegerOutput,StepNumberOutput,StepBooleanOutput,StepFolderOutput,StepFileOutput,StepPathOutput,StepArrayOutput,StepJSONObjectOutput>> outputs = default(List<AnyOf<StepStringOutput,StepIntegerOutput,StepNumberOutput,StepBooleanOutput,StepFolderOutput,StepFileOutput,StepPathOutput,StepArrayOutput,StepJSONObjectOutput>>), DateTime startedAt = default(DateTime), string id = default(string), string jobId = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string message = default(string), DateTime finishedAt = default(DateTime), string source = default(string), string entrypoint = default(string), RunStatusEnum? status = default(RunStatusEnum?), Dictionary<string, StepStatus> steps = default(Dictionary<string, StepStatus>)) : base()
        {
