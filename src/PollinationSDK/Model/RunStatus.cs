...
namespace PollinationSDK
{
    ...
    public partial class RunStatus : IEquatable<RunStatus>, IValidatableObject
    {
        ...
        (
           ...
           Dictionary<string, string> annotations= default, string entrypoint= default, DateTime finishedAt= default, string message= default, string source= default, RunStatusEnum status= RunStatusEnum.Unknown, Dictionary<string, StepStatus> steps= default // Optional parameters
        )// BaseClass
        {
