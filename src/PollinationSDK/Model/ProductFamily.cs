...
namespace PollinationSDK
{
    ...
    public partial class ProductFamily : Product, IEquatable<ProductFamily>, IValidatableObject
    {
        /// <summary>
        ...
        (
            string id, bool active, string name, List<Price> prices, // Required parameters
            Object metadata= default, string description= default // Optional parameters
        ) : base(id: id, metadata: metadata, active: active, name: name, description: description)// BaseClass
        {
        ...
        /// </summary>
        /// <returns>OpenAPIGenBaseModel</returns>
        public override Product DuplicateProduct()
        {
            return DuplicateProductFamily();
        }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^ProductFamily$", RegexOptions.CultureInvariant);
