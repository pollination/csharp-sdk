...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BodyPostRecipeRegistriesOwnerRecipesPost :  IEquatable<BodyPostRecipeRegistriesOwnerRecipesPost>, IValidatableObject
    {
        /// <summary>
        ...
        )// BaseClass
        {
            ...
            if (package == null)
            {
                throw new InvalidDataException("package is a required property for BodyPostRecipeRegistriesOwnerRecipesPost and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class BodyPostRecipeRegistriesOwnerRecipesPost {\n");
        ...
        {
            var obj = JsonConvert.DeserializeObject<BodyPostRecipeRegistriesOwnerRecipesPost>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>BodyPostRecipeRegistriesOwnerRecipesPost object</returns>
        public BodyPostRecipeRegistriesOwnerRecipesPost DuplicateBodyPostRecipeRegistriesOwnerRecipesPost()
        {
