...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DAGFolderOutputAlias :  IEquatable<DAGFolderOutputAlias>, IValidatableObject
    {
        /// <summary>
        ...
        (
           AnyOf<TaskReference,FolderReference> from, List<IOAliasHandler> handler, string name, List<string> platform, // Required parameters
        ...
        )// BaseClass
        {
            ...
            if (handler == null)
            {
                throw new InvalidDataException("handler is a required property for DAGFolderOutputAlias and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGFolderOutputAlias and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (platform == null)
            {
                throw new InvalidDataException("platform is a required property for DAGFolderOutputAlias and cannot be null");
            }
            else
            {
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGFolderOutputAlias>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>DAGFolderOutputAlias object</returns>
        public DAGFolderOutputAlias DuplicateDAGFolderOutputAlias()
        {
