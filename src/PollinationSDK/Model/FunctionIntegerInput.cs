...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FunctionIntegerInput :  IEquatable<FunctionIntegerInput>, IValidatableObject
    {
        /// <summary>
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for FunctionIntegerInput and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FunctionIntegerInput {\n");
        ...
        {
            var obj = JsonConvert.DeserializeObject<FunctionIntegerInput>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>FunctionIntegerInput object</returns>
        public FunctionIntegerInput DuplicateFunctionIntegerInput()
        {
