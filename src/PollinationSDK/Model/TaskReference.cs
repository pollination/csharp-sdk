...
namespace PollinationSDK.Model
{
    ...
    public partial class TaskReference : TaskReferenceBase,  IEquatable<TaskReference>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="TaskReference" /> class.
        /// </summary>
        public TaskReference(Dictionary<string, string> annotations = default(Dictionary<string, string>), string name = default(string), string variable = default(string)) : base()
        {
        }
