...
namespace PollinationSDK.Model
{
    ...
    public partial class SubscriptionUpdate :  IEquatable<SubscriptionUpdate>, IValidatableObject
    {
        ...
        (
           // Required parameters
           List<NewSubscriptionItem> toAdd= default, List<SubscriptionItem> toDelete= default, Price toSubscribe= default, List<SubscriptionItem> toUpdate= default// Optional parameters
        )// BaseClass
        {
            this.ToAdd = toAdd;
