...
namespace PollinationSDK.Model
{
    ...
    public partial class DAGInputArtifact :  IEquatable<DAGInputArtifact>, IValidatableObject
    {
        ...
        (
           ...
           Dictionary<string, string> annotations= default, AnyOfobjectobjectobject _default= default, string description= default, bool required= default// Optional parameters
        )// BaseClass
        {
        ...
        public AnyOfobjectobjectobject Default { get; set; } 
        /// <summary>
