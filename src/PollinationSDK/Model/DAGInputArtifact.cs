...
namespace PollinationSDK.Model
{
    ...
    public partial class DAGInputArtifact :  IEquatable<DAGInputArtifact>, IValidatableObject
    {
        ...
        (
           ...
           Dictionary<string, string> annotations= default, AnyOf<HTTPSource,S3Source,ProjectFolderSource> _default= default, string description= default, bool required= default// Optional parameters
        )// BaseClass
        {
