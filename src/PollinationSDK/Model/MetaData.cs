...
namespace PollinationSDK.Model
{
    ...
    public partial class MetaData :  IEquatable<MetaData>, IValidatableObject
    {
        ...
        (
           ...
           string appVersion= default, bool deprecated= default, string description= default, string home= default, string icon= default, List<string> keywords= default, License license= default, List<Maintainer> maintainers= default, List<string> sources= default // Optional parameters
        )// BaseClass
        {
