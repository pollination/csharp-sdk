...
namespace PollinationSDK.Model
{
    ...
    public partial class MetaData : OpenAPIGenBaseModel,  IEquatable<MetaData>, IValidatableObject
    {
        ...
        public MetaData(string name = default(string), string tag = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string appVersion = default(string), List<string> keywords = default(List<string>), List<Maintainer> maintainers = default(List<Maintainer>), string home = default(string), List<string> sources = default(List<string>), string icon = default(string), bool deprecated = default(bool), string description = default(string), License license = default(License)) : base()
        {
