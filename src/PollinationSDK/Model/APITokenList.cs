...
namespace PollinationSDK.Model
{
    ...
    public partial class APITokenList : OpenAPIGenBaseModel,  IEquatable<APITokenList>, IValidatableObject
    {
        /// <summary>
        ...
        public APITokenList(int page = default(int), int perPage = default(int), int pageCount = default(int), int totalCount = default(int), List<APIToken> resources = default(List<APIToken>), int nextPage = default(int)) : base()
        {
            // to ensure "page" is required (not null)
            if (page == null)
            {
                throw new InvalidDataException("page is a required property for APITokenList and cannot be null");
            }
            else
            {
                this.Page = page;
            ...
            if (perPage == null)
            {
                throw new InvalidDataException("perPage is a required property for APITokenList and cannot be null");
            }
            else
            {
            ...
            if (pageCount == null)
            {
                throw new InvalidDataException("pageCount is a required property for APITokenList and cannot be null");
            }
            else
            {
            ...
            if (resources == null)
            {
                throw new InvalidDataException("resources is a required property for APITokenList and cannot be null");
            }
            else
            {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^APITokenList$", RegexOptions.CultureInvariant);
