...
namespace PollinationSDK
{
    ...
    public partial class APITokenList : OpenAPIGenBaseModel, IEquatable<APITokenList>, IValidatableObject
    {
        ...
        public APITokenList
        (
           int page, int perPage, int pageCount, int totalCount, List<APIToken> resources, // Required parameters
        ...
        public override string Type { get; protected set; }  = "APITokenList";
