...
namespace PollinationSDK.Model
{
    ...
    public partial class FunctionArtifact :  IEquatable<FunctionArtifact>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for FunctionArtifact and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (path == null)
            {
                throw new InvalidDataException("path is a required property for FunctionArtifact and cannot be null");
            }
            else
            {
                this.Path = path;
        ...
        {
            var obj = JsonConvert.DeserializeObject<FunctionArtifact>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        {
            return this.Equals(input as FunctionArtifact);
        }

        /// <summary>
        /// Returns true if FunctionArtifact instances are equal
        /// </summary>
        /// <param name="input">Instance of FunctionArtifact to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FunctionArtifact input)
        {
            if (input == null)
                return false;
            return 
