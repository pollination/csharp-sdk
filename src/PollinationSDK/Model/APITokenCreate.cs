...
namespace PollinationSDK.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(APITokenPrivate), "APITokenPrivate")]
    public partial class APITokenCreate : APIToken,  IEquatable<APITokenCreate>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="APITokenCreate" /> class.
        /// </summary>
        public APITokenCreate(string tokenId = default(string), string name = default(string), Dictionary<string, string> claims = default(Dictionary<string, string>)) : base(tokenId, name, claims)
        {
        }
