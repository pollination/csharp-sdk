...
namespace PollinationSDK.Model
{
    ...
    public partial class TaskReturn : GenericOutput,  IEquatable<TaskReturn>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="TaskReturn" /> class.
        /// </summary>
        public TaskReturn(string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string)) : base(name, annotations, description)
        {
        }
