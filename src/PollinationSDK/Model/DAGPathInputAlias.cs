...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DAGPathInputAlias :  IEquatable<DAGPathInputAlias>, IValidatableObject
    {
        /// <summary>
        ...
        )// BaseClass
        {
            ...
            if (handler == null)
            {
                throw new InvalidDataException("handler is a required property for DAGPathInputAlias and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGPathInputAlias and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (platform == null)
            {
                throw new InvalidDataException("platform is a required property for DAGPathInputAlias and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DAGPathInputAlias {\n");
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGPathInputAlias>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>DAGPathInputAlias object</returns>
        public DAGPathInputAlias DuplicateDAGPathInputAlias()
        {
