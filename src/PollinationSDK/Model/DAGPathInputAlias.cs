...
namespace PollinationSDK.Model
{
    ...
    public partial class DAGPathInputAlias : GenericInput,  IEquatable<DAGPathInputAlias>, IValidatableObject
    {
        ...
        public DAGPathInputAlias(List<string> platform = default(List<string>), List<IOAliasHandler> handler = default(List<IOAliasHandler>), AnyOf<HTTP,S3,ProjectFolder> _default = default(AnyOf<HTTP,S3,ProjectFolder>), bool required = false, Object spec = default(Object), List<string> extensions = default(List<string>), string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string)) : base(name, annotations, description)
        {
