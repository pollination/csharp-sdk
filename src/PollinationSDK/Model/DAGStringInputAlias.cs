...
namespace PollinationSDK
{
    ...
    public partial class DAGStringInputAlias : IEquatable<DAGStringInputAlias>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            this.Handler = handler ?? throw new ArgumentNullException("handler is a required property for DAGStringInputAlias and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for DAGStringInputAlias and cannot be null");
            // to ensure "platform" is required (not null)
            this.Platform = platform ?? throw new ArgumentNullException("platform is a required property for DAGStringInputAlias and cannot be null");
        ...
        public string Type { get; protected internal set; }  = "DAGStringInputAlias";
