...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DAGFileInputAlias :  IEquatable<DAGFileInputAlias>, IValidatableObject
    {
        /// <summary>
        ...
        (
           ...
           Dictionary<string, string> annotations= default, AnyOf<HTTP,S3,ProjectFolder> _default= default, string description= default, List<string> extensions= default, bool required = false, Object spec= default // Optional parameters
        )// BaseClass
        {
            // to ensure "handler" is required (not null)
            if (handler == null)
            {
                throw new InvalidDataException("handler is a required property for DAGFileInputAlias and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGFileInputAlias and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (platform == null)
            {
                throw new InvalidDataException("platform is a required property for DAGFileInputAlias and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DAGFileInputAlias {\n");
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGFileInputAlias>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>DAGFileInputAlias object</returns>
        public DAGFileInputAlias DuplicateDAGFileInputAlias()
        {
