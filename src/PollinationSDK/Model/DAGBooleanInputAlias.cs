...
namespace PollinationSDK.Model
{
    ...
    public partial class DAGBooleanInputAlias : GenericInput,  IEquatable<DAGBooleanInputAlias>, IValidatableObject
    {
        ...
        public DAGBooleanInputAlias(List<string> platform = default(List<string>), List<IOAliasHandler> handler = default(List<IOAliasHandler>), bool _default = default(bool), bool required = false, Object spec = default(Object), string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string)) : base(name, annotations, description)
        {
