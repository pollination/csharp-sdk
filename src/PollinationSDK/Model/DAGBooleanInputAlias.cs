...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DAGBooleanInputAlias :  IEquatable<DAGBooleanInputAlias>, IValidatableObject
    {
        /// <summary>
        ...
        (
           ...
           Dictionary<string, string> annotations= default, bool _default= default, string description= default, bool required = false, Object spec= default // Optional parameters
        )// BaseClass
        {
            // to ensure "handler" is required (not null)
            if (handler == null)
            {
                throw new InvalidDataException("handler is a required property for DAGBooleanInputAlias and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGBooleanInputAlias and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (platform == null)
            {
                throw new InvalidDataException("platform is a required property for DAGBooleanInputAlias and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DAGBooleanInputAlias {\n");
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGBooleanInputAlias>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>DAGBooleanInputAlias object</returns>
        public DAGBooleanInputAlias DuplicateDAGBooleanInputAlias()
        {
