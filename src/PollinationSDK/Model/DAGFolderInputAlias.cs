...
namespace PollinationSDK.Model
{
    ...
    public partial class DAGFolderInputAlias : GenericInput,  IEquatable<DAGFolderInputAlias>, IValidatableObject
    {
        ...
        public DAGFolderInputAlias(List<string> platform = default(List<string>), List<IOAliasHandler> handler = default(List<IOAliasHandler>), AnyOf<HTTP,S3,ProjectFolder> _default = default(AnyOf<HTTP,S3,ProjectFolder>), bool required = false, Object spec = default(Object), string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string)) : base(name, annotations, description)
        {
