...
namespace PollinationSDK
{
    ...
    public partial class Status : OpenAPIGenBaseModel, IEquatable<Status>, IValidatableObject
    {
        /// <summary>
        ...
        public override string Type { get; protected internal set; }  = "Status";
        ...
        [DataMember(Name = "frozen", EmitDefaultValue = true)]
        ...
        {
            var obj = JsonConvert.DeserializeObject<Status>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>Status object</returns>
        public virtual Status DuplicateStatus()
        {
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^Status$", RegexOptions.CultureInvariant);
