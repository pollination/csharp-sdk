...
namespace PollinationSDK
{
    ...
    public partial class PaymentSetup : SecureResourcePublic, IEquatable<PaymentSetup>, IValidatableObject
    {
        /// <summary>
        ...
        public override string Type { get; protected internal set; }  = "PaymentSetup";
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^PaymentSetup$", RegexOptions.CultureInvariant);
