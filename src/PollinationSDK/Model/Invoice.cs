...
namespace PollinationSDK.Model
{
    ...
    public partial class Invoice :  IEquatable<Invoice>, IValidatableObject
    {
        ...
        public Invoice
        (
           string collectionMethod, string currency, string customer, string id, LineItemList lines, DateTime periodEnd, DateTime periodStart, InvoiceStatus status, InvoiceStatusTransitions statusTransitions, string subscription, int total, // Required parameters
           bool autoAdvance= default, string description= default, string hostedInvoiceUrl= default, Object metadata= default // Optional parameters
        )// BaseClass
        {
            ...
            {
                throw new InvalidDataException("subscription is a required property for Invoice and cannot be null");
            }
            else
            {
