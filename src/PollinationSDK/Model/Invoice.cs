...
namespace PollinationSDK.Model
{
    ...
    public partial class Invoice :  IEquatable<Invoice>, IValidatableObject
    {
        ...
        public Invoice
        (
           string collectionMethod, string currency, string customer, string id, LineItemList lines, DateTime periodEnd, DateTime periodStart, InvoiceStatus status, string subscription, int total, // Required parameters
