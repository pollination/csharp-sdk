...
namespace PollinationSDK.Model
{
    ...
    public partial class Invoice :  IEquatable<Invoice>, IValidatableObject
    {
        ...
        (
           ...
           bool autoAdvance= default, string description= default, Discount discount= default, string hostedInvoiceUrl= default, Object metadata= default, string subscription= default, int tax= default, List<DiscountAmount> totalDiscountAmounts= default, List<TaxAmount> totalTaxAmounts= default// Optional parameters
        )// BaseClass
        {
            ...
            if (subtotal == null)
            {
                throw new InvalidDataException("subtotal is a required property for Invoice and cannot be null");
            }
            else
            {
