...
namespace PollinationSDK.Model
{
    ...
    public partial class Invoice :  IEquatable<Invoice>, IValidatableObject
    {
        ...
        (
           ...
           bool autoAdvance= default, string description= default, Discount discount= default, string hostedInvoiceUrl= default, Object metadata= default, string subscription= default, List<DiscountAmount> totalDiscountAmounts= default// Optional parameters
        )// BaseClass
        {
