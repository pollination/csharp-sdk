...
namespace PollinationSDK.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(StepBooleanOutput), "StepBooleanOutput")]
    public partial class FunctionBooleanOutput : FunctionStringOutput,  IEquatable<FunctionBooleanOutput>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="FunctionBooleanOutput" /> class.
        /// </summary>
        public FunctionBooleanOutput(string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string), string path = default(string), bool required = true) : base()
        {
        }
