...
namespace PollinationSDK.Model
{
    ...
    public partial class ValueFolderReference :  IEquatable<ValueFolderReference>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            if (path == null)
            {
                throw new InvalidDataException("path is a required property for ValueFolderReference and cannot be null");
            }
            else
            {
                this.Path = path;
        ...
        {
            var obj = JsonConvert.DeserializeObject<ValueFolderReference>(json, JsonSetting.ConvertSetting);
            return obj;
        }
