...
namespace PollinationSDK
{
    ...
    public partial class FunctionPathOutput : IEquatable<FunctionPathOutput>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for FunctionPathOutput and cannot be null");
            // to ensure "path" is required (not null)
            this.Path = path ?? throw new ArgumentNullException("path is a required property for FunctionPathOutput and cannot be null");
        ...
        public string Type { get; protected internal set; }  = "FunctionPathOutput";
