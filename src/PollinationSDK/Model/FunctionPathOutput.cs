...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FunctionPathOutput :  IEquatable<FunctionPathOutput>, IValidatableObject
    {
        /// <summary>
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for FunctionPathOutput and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (path == null)
            {
                throw new InvalidDataException("path is a required property for FunctionPathOutput and cannot be null");
            }
            else
            {
                this.Path = path;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FunctionPathOutput {\n");
        ...
        {
            var obj = JsonConvert.DeserializeObject<FunctionPathOutput>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>FunctionPathOutput object</returns>
        public FunctionPathOutput DuplicateFunctionPathOutput()
        {
