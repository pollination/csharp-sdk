...
namespace PollinationSDK.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(StepPathOutput), "StepPathOutput")]
    public partial class FunctionPathOutput : PathOutput,  IEquatable<FunctionPathOutput>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="FunctionPathOutput" /> class.
        /// </summary>
        public FunctionPathOutput(string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string), string path = default(string), bool required = true) : base(path, required)
        {
        }
