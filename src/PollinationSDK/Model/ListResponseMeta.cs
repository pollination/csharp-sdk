...
namespace PollinationSDK
{
    ...
    /// </summary>
    [DataContract(Name = "ListResponseMeta")]
    public partial class ListResponseMeta : OpenAPIGenBaseModel, IEquatable<ListResponseMeta>, IValidatableObject
    {
        ...
        (
           int page, int perPage, int pageCount, int totalCount, // Required parameters
           int nextPage= default, List<object> resources= default // Optional parameters
        ) : base()// BaseClass
        {
            this.Page = page;
        ...
        public override string Type { get; protected internal set; }  = "ListResponseMeta";
        ...
        /// </summary>
        /// <returns>ListResponseMeta object</returns>
        public static ListResponseMeta FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<ListResponseMeta>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        {
            return DuplicateListResponseMeta();
        }
