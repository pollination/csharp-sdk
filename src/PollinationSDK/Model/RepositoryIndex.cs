...
namespace PollinationSDK.Model
{
    ...
    public partial class RepositoryIndex : OpenAPIGenBaseModel,  IEquatable<RepositoryIndex>, IValidatableObject
    {
        ...
        public RepositoryIndex(Dictionary<string, string> annotations = default(Dictionary<string, string>), DateTime generated = default(DateTime), RepositoryMetadata metadata = default(RepositoryMetadata), Dictionary<string, List<PackageVersion>> plugin = default(Dictionary<string, List<PackageVersion>>), Dictionary<string, List<PackageVersion>> recipe = default(Dictionary<string, List<PackageVersion>>)) : base()
        {
