...
namespace PollinationSDK.Model
{
    ...
    public partial class WorkflowStatus :  IEquatable<WorkflowStatus>, IValidatableObject
    {
        ...
        (
           string id, DateTime startedAt, string status, // Required parameters
           string entrypoint= default, DateTime finishedAt= default, string message= default, Dictionary<string, TaskStatus> tasks= default// Optional parameters
        )// BaseClass
        {
