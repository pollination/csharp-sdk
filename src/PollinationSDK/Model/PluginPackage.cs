...
namespace PollinationSDK.Model
{
    ...
    public partial class PluginPackage : RepositoryPackage,  IEquatable<PluginPackage>, IValidatableObject
    {
        ...
        public PluginPackage(Plugin manifest = default(Plugin), string digest = default(string), string tag = default(string), List<string> keywords = default(List<string>), string description = default(string), string icon = default(string), DateTime createdAt = default(DateTime), string readme = default(string)) : base(digest, tag, keywords, description, icon, createdAt, readme)
        {
