...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PluginPackage :  IEquatable<PluginPackage>, IValidatableObject
    {
        /// <summary>
        ...
        (
           string digest, Plugin manifest, string tag, // Required parameters
        ...
        )// BaseClass
        {
            ...
            if (digest == null)
            {
                throw new InvalidDataException("digest is a required property for PluginPackage and cannot be null");
            }
            else
            {
                this.Digest = digest;
            ...
            if (manifest == null)
            {
                throw new InvalidDataException("manifest is a required property for PluginPackage and cannot be null");
            }
            else
            {
            ...
            if (tag == null)
            {
                throw new InvalidDataException("tag is a required property for PluginPackage and cannot be null");
            }
            else
            {
                this.Tag = tag;
        ...
        {
            var obj = JsonConvert.DeserializeObject<PluginPackage>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>PluginPackage object</returns>
        public PluginPackage DuplicatePluginPackage()
        {
