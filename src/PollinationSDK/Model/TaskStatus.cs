...
namespace PollinationSDK.Model
{
    ...
    public partial class TaskStatus :  IEquatable<TaskStatus>, IValidatableObject
    {
        ...
        public TaskStatus
        (
           List<string> children, string id, Arguments inputs, string name, List<string> outboundTasks, Arguments outputs, DateTime startedAt, string status, string templateRef, TypeEnum type, // Required parameters
