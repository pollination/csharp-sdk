...
namespace PollinationSDK.Model
{
    ...
    public partial class TaskStatus :  IEquatable<TaskStatus>, IValidatableObject
    {
        ...
        public TaskStatus
        (
           List<string> children, string id, Arguments inputs, string name, List<string> outboundTasks, Arguments outputs, DateTime startedAt, string status, string templateRef, StatusType type, // Required parameters
           string boundaryId= default, string command= default, DateTime finishedAt= default, string message= default // Optional parameters
        )// BaseClass
        {
