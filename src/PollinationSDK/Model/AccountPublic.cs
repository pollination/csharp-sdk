...
namespace PollinationSDK.Model
{
    ...
    public partial class AccountPublic : OpenAPIGenBaseModel,  IEquatable<AccountPublic>, IValidatableObject
    {
        ...
        public AccountPublic(string id = default(string), string accountType = default(string), string name = default(string), string displayName = default(string), string description = default(string), string pictureUrl = default(string)) : base()
        {
