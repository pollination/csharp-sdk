...
namespace PollinationSDK.Model
{
    ...
    public partial class LicensePoolAccessPolicy :  IEquatable<LicensePoolAccessPolicy>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            if (subject == null)
            {
                throw new InvalidDataException("subject is a required property for LicensePoolAccessPolicy and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LicensePoolAccessPolicy {\n");
        ...
        {
            var obj = JsonConvert.DeserializeObject<LicensePoolAccessPolicy>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>LicensePoolAccessPolicy object</returns>
        public LicensePoolAccessPolicy DuplicateLicensePoolAccessPolicy()
        {
