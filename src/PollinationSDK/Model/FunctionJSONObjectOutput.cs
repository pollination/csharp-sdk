...
namespace PollinationSDK.Model
{
    ...
    [JsonSubtypes.KnownSubType(typeof(StepJSONObjectOutput), "StepJSONObjectOutput")]
    public partial class FunctionJSONObjectOutput : FunctionStringOutput,  IEquatable<FunctionJSONObjectOutput>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="FunctionJSONObjectOutput" /> class.
        /// </summary>
        public FunctionJSONObjectOutput(string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string), string path = default(string), bool required = true) : base()
        {
        }
