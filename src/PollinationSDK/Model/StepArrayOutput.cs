...
namespace PollinationSDK
{
    ...
    public partial class StepArrayOutput : IEquatable<StepArrayOutput>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for StepArrayOutput and cannot be null");
            // to ensure "path" is required (not null)
            this.Path = path ?? throw new ArgumentNullException("path is a required property for StepArrayOutput and cannot be null");
