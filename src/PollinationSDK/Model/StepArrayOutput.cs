...
namespace PollinationSDK.Model
{
    ...
    public partial class StepArrayOutput : FunctionStringOutput,  IEquatable<StepArrayOutput>, IValidatableObject
    {
        ...
        public StepArrayOutput(List<object> value = default(List<object>), ItemType? itemsType = default(ItemType?), string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string), string path = default(string), bool required = true) : base()
        {
