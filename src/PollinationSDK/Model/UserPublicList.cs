...
namespace PollinationSDK
{
    ...
    public partial class UserPublicList : OpenAPIGenBaseModel, IEquatable<UserPublicList>, IValidatableObject
    {
        ...
        (
           int page, int perPage, int pageCount, int totalCount, List<UserPublic> resources, // Required parameters
        ...
        public override string Type { get; protected internal set; }  = "UserPublicList";
