...
namespace PollinationSDK.Model
{
    ...
    public partial class UserPublicList : OpenAPIGenBaseModel,  IEquatable<UserPublicList>, IValidatableObject
    {
        /// <summary>
        ...
        public UserPublicList(int page = default(int), int perPage = default(int), int pageCount = default(int), int totalCount = default(int), List<UserPublic> resources = default(List<UserPublic>), int nextPage = default(int)) : base()
        {
            // to ensure "page" is required (not null)
            if (page == null)
            {
                throw new InvalidDataException("page is a required property for UserPublicList and cannot be null");
            }
            else
            {
                this.Page = page;
            ...
            if (perPage == null)
            {
                throw new InvalidDataException("perPage is a required property for UserPublicList and cannot be null");
            }
            else
            {
            ...
            if (pageCount == null)
            {
                throw new InvalidDataException("pageCount is a required property for UserPublicList and cannot be null");
            }
            else
            {
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for UserPublicList and cannot be null");
            }
            else
            {
            ...
            if (resources == null)
            {
                throw new InvalidDataException("resources is a required property for UserPublicList and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserPublicList {\n");
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^UserPublicList$", RegexOptions.CultureInvariant);
