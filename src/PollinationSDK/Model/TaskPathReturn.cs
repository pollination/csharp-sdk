...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TaskPathReturn :  IEquatable<TaskPathReturn>, IValidatableObject
    {
        /// <summary>
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for TaskPathReturn and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (path == null)
            {
                throw new InvalidDataException("path is a required property for TaskPathReturn and cannot be null");
            }
            else
            {
                this.Path = path;
        ...
        {
            var obj = JsonConvert.DeserializeObject<TaskPathReturn>(json, JsonSetting.ConvertSetting);
            return obj;
        }
