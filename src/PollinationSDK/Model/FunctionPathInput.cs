...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class FunctionPathInput :  IEquatable<FunctionPathInput>, IValidatableObject
    {
        /// <summary>
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for FunctionPathInput and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (path == null)
            {
                throw new InvalidDataException("path is a required property for FunctionPathInput and cannot be null");
            }
            else
            {
                this.Path = path;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class FunctionPathInput {\n");
        ...
        {
            var obj = JsonConvert.DeserializeObject<FunctionPathInput>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>FunctionPathInput object</returns>
        public FunctionPathInput DuplicateFunctionPathInput()
        {
