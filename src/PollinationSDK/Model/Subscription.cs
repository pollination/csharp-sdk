...
namespace PollinationSDK.Model
{
    ...
    public partial class Subscription :  IEquatable<Subscription>, IValidatableObject
    {
        ...
        public Subscription
        (
           bool cancelAtPeriodEnd, DateTime currentPeriodEnd, DateTime currentPeriodStart, string customer, string id, SubscriptionItemList items, string latestInvoice, // Required parameters
           string defaultPaymentMethod= default // Optional parameters
        )// BaseClass
        {
