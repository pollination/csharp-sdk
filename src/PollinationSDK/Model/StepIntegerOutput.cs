...
namespace PollinationSDK
{
    ...
    public partial class StepIntegerOutput : IEquatable<StepIntegerOutput>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for StepIntegerOutput and cannot be null");
            // to ensure "path" is required (not null)
            this.Path = path ?? throw new ArgumentNullException("path is a required property for StepIntegerOutput and cannot be null");
            this.Value = value;
        ...
        public string Type { get; protected internal set; }  = "StepIntegerOutput";
