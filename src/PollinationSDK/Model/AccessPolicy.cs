...
namespace PollinationSDK
{
    ...
    public partial class AccessPolicy : OpenAPIGenBaseModel, IEquatable<AccessPolicy>, IValidatableObject
    {
        ...
        ) : base()// BaseClass
        {
            ...
            this.Subject = subject ?? throw new ArgumentNullException("subject is a required property for AccessPolicy and cannot be null");
        ...
        public override string Type { get; protected set; }  = "AccessPolicy";
        ...
        /// </summary>
        /// <returns>AccessPolicy object</returns>
        public static AccessPolicy FromJson(string json)
        {
            var obj = JsonConvert.DeserializeObject<AccessPolicy>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>AccessPolicy object</returns>
        public virtual AccessPolicy DuplicateAccessPolicy()
        {
