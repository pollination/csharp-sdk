...
namespace PollinationSDK.Model
{
    ...
    public partial class RepositoryAbridgedDto :  IEquatable<RepositoryAbridgedDto>, IValidatableObject
    {
        ...
        (
           string latestTag, string name, AccountPublic owner, // Required parameters
           string description= default, string icon= default, List<string> keywords= default, bool _public = true, string slug= default// Optional parameters
        )// BaseClass
        {
        ...
        {
            var obj = JsonConvert.DeserializeObject<RepositoryAbridgedDto>(json, JsonSetting.ConvertSetting);
            return obj;
        }
