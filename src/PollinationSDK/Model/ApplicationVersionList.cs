...
namespace PollinationSDK
{
    ...
    /// </summary>
    [DataContract(Name = "ApplicationVersionList")]
    public partial class ApplicationVersionList : OpenAPIGenBaseModel, IEquatable<ApplicationVersionList>, IValidatableObject
    {
        /// <summary>
        ...
        { 
            ...
            this.Type = "ApplicationVersionList";
        }
        ...
        (
           int page, int perPage, int pageCount, int totalCount, List<ApplicationVersion> resources, // Required parameters
        ...
        ) : base()// BaseClass
        {
            ...
            this.Resources = resources ?? throw new ArgumentNullException("resources is a required property for ApplicationVersionList and cannot be null");
        ...
        public override string Type { get; protected set; }  = "ApplicationVersionList";
        ...
        public override string ToString(bool detailed)
        {
            ...
            sb.Append("ApplicationVersionList:\n");
        ...
        {
            var obj = JsonConvert.DeserializeObject<ApplicationVersionList>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>ApplicationVersionList object</returns>
        public virtual ApplicationVersionList DuplicateApplicationVersionList()
        {
        ...
        {
            return DuplicateApplicationVersionList();
        }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^ApplicationVersionList$", RegexOptions.CultureInvariant);
