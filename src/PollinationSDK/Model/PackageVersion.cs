...
namespace PollinationSDK.Model
{
    ...
    public partial class PackageVersion : OpenAPIGenBaseModel,  IEquatable<PackageVersion>, IValidatableObject
    {
        ...
        public PackageVersion(string name = default(string), string tag = default(string), string url = default(string), DateTime created = default(DateTime), string digest = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string appVersion = default(string), List<string> keywords = default(List<string>), List<Maintainer> maintainers = default(List<Maintainer>), string home = default(string), List<string> sources = default(List<string>), string icon = default(string), bool deprecated = default(bool), string description = default(string), License license = default(License), string slug = default(string), string kind = "", string readme = default(string), AnyOf<Recipe,Plugin> manifest = default(AnyOf<Recipe,Plugin>)) : base()
        {
