...
namespace PollinationSDK.Model
{
    ...
    public partial class DAGFileOutputAlias : DAGArtifactOutputAlias,  IEquatable<DAGFileOutputAlias>, IValidatableObject
    {
        ...
        public DAGFileOutputAlias(AnyOf<TaskReference,FileReference> from = default(AnyOf<TaskReference,FileReference>), string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string), List<string> platform = default(List<string>), List<IOAliasHandler> handler = default(List<IOAliasHandler>), bool required = true) : base()
        {
