...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DAGFileOutputAlias :  IEquatable<DAGFileOutputAlias>, IValidatableObject
    {
        /// <summary>
        ...
        )// BaseClass
        {
            ...
            if (from == null)
            {
                throw new InvalidDataException("from is a required property for DAGFileOutputAlias and cannot be null");
            }
            else
            {
                this.From = from;
            ...
            if (handler == null)
            {
                throw new InvalidDataException("handler is a required property for DAGFileOutputAlias and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGFileOutputAlias and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (platform == null)
            {
                throw new InvalidDataException("platform is a required property for DAGFileOutputAlias and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DAGFileOutputAlias {\n");
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGFileOutputAlias>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>DAGFileOutputAlias object</returns>
        public DAGFileOutputAlias DuplicateDAGFileOutputAlias()
        {
