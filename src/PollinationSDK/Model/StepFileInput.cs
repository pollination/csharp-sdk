...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StepFileInput :  IEquatable<StepFileInput>, IValidatableObject
    {
        /// <summary>
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for StepFileInput and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            var obj = JsonConvert.DeserializeObject<StepFileInput>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>StepFileInput object</returns>
        public StepFileInput DuplicateStepFileInput()
        {
