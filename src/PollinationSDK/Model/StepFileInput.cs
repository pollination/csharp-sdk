...
namespace PollinationSDK.Model
{
    ...
    public partial class StepFileInput : GenericInput,  IEquatable<StepFileInput>, IValidatableObject
    {
        ...
        public StepFileInput(AnyOf<HTTP,S3,ProjectFolder> source = default(AnyOf<HTTP,S3,ProjectFolder>), AnyOf<HTTP,S3,ProjectFolder> _default = default(AnyOf<HTTP,S3,ProjectFolder>), List<AnyOf<DAGGenericInputAlias,DAGStringInputAlias,DAGIntegerInputAlias,DAGNumberInputAlias,DAGBooleanInputAlias,DAGFolderInputAlias,DAGFileInputAlias,DAGPathInputAlias,DAGArrayInputAlias,DAGJSONObjectInputAlias,DAGLinkedInputAlias>> alias = default(List<AnyOf<DAGGenericInputAlias,DAGStringInputAlias,DAGIntegerInputAlias,DAGNumberInputAlias,DAGBooleanInputAlias,DAGFolderInputAlias,DAGFileInputAlias,DAGPathInputAlias,DAGArrayInputAlias,DAGJSONObjectInputAlias,DAGLinkedInputAlias>>), bool required = false, Object spec = default(Object), string path = default(string), List<string> extensions = default(List<string>), string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string)) : base(name, annotations, description)
        {
            // to ensure "source" is required (not null)
            if (source == null)
            {
                throw new InvalidDataException("source is a required property for StepFileInput and cannot be null");
            }
            else
            {
                this.Source = source;
