...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StepFileOutput :  IEquatable<StepFileOutput>, IValidatableObject
    {
        /// <summary>
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for StepFileOutput and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (path == null)
            {
                throw new InvalidDataException("path is a required property for StepFileOutput and cannot be null");
            }
            else
            {
                this.Path = path;
        ...
        {
            var obj = JsonConvert.DeserializeObject<StepFileOutput>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>StepFileOutput object</returns>
        public StepFileOutput DuplicateStepFileOutput()
        {
