...
namespace PollinationSDK
{
    ...
    public partial class SubscriptionItem : ExternalResource, IEquatable<SubscriptionItem>, IValidatableObject
    {
        /// <summary>
        ...
        public override string Type { get; protected internal set; }  = "SubscriptionItem";
        ...
        {
            var obj = JsonConvert.DeserializeObject<SubscriptionItem>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>SubscriptionItem object</returns>
        public virtual SubscriptionItem DuplicateSubscriptionItem()
        {
        ...
        {
            return DuplicateSubscriptionItem();
        }
        ...
        protected IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> BaseValidate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^SubscriptionItem$", RegexOptions.CultureInvariant);
