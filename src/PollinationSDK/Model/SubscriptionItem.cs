...
namespace PollinationSDK
{
    ...
    public partial class SubscriptionItem : IEquatable<SubscriptionItem>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            this.Id = id ?? throw new ArgumentNullException("id is a required property for SubscriptionItem and cannot be null");
            // to ensure "price" is required (not null)
            this.Price = price ?? throw new ArgumentNullException("price is a required property for SubscriptionItem and cannot be null");
