...
namespace PollinationSDK.Model
{
    ...
    public partial class ApplicationUpdate :  IEquatable<ApplicationUpdate>, IValidatableObject
    {
        ...
        (
           // Required parameters
           DeploymentConfigUpdate deploymentConfig= default, string description= default, bool isPaid= default, List<string> keywords= default, string license= default, bool _public= default, string source= default// Optional parameters
        )// BaseClass
        {
        ...
        public DeploymentConfigUpdate DeploymentConfig { get; set; } 
        /// <summary>
