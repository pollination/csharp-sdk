...
namespace PollinationSDK.Model
{
    ...
    public partial class TaskPathArgument : OpenAPIGenBaseModel,  IEquatable<TaskPathArgument>, IValidatableObject
    {
        ...
        public TaskPathArgument(string name = default(string), AnyOf<InputFileReference,InputFolderReference,InputPathReference,TaskFileReference,TaskFolderReference,TaskPathReference,ValueFileReference,ValueFolderReference> from = default(AnyOf<InputFileReference,InputFolderReference,InputPathReference,TaskFileReference,TaskFolderReference,TaskPathReference,ValueFileReference,ValueFolderReference>), Dictionary<string, string> annotations = default(Dictionary<string, string>), string subPath = default(string)) : base()
        {
