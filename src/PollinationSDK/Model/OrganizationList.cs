...
namespace PollinationSDK.Model
{
    ...
    public partial class OrganizationList : OpenAPIGenBaseModel,  IEquatable<OrganizationList>, IValidatableObject
    {
        ...
        public OrganizationList(int page = default(int), int perPage = default(int), int pageCount = default(int), int totalCount = default(int), List<Organization> resources = default(List<Organization>), int nextPage = default(int)) : base()
        {
