...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class OrganizationList :  IEquatable<OrganizationList>, IValidatableObject
    {
        /// <summary>
        ...
        (
           int page, int pageCount, int perPage, List<Organization> resources, int totalCount, // Required parameters
        ...
        )// BaseClass
        {
            ...
            if (page == null)
            {
                throw new InvalidDataException("page is a required property for OrganizationList and cannot be null");
            }
            else
            {
                this.Page = page;
            ...
            if (pageCount == null)
            {
                throw new InvalidDataException("pageCount is a required property for OrganizationList and cannot be null");
            }
            else
            {
            ...
            if (perPage == null)
            {
                throw new InvalidDataException("perPage is a required property for OrganizationList and cannot be null");
            }
            else
            {
            ...
            if (resources == null)
            {
                throw new InvalidDataException("resources is a required property for OrganizationList and cannot be null");
            }
            else
            {
            ...
            if (totalCount == null)
            {
                throw new InvalidDataException("totalCount is a required property for OrganizationList and cannot be null");
            }
            else
            {
        ...
        {
            var obj = JsonConvert.DeserializeObject<OrganizationList>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>OrganizationList object</returns>
        public OrganizationList DuplicateOrganizationList()
        {
