...
namespace PollinationSDK.Model
{
    ...
    public partial class DAGArrayInputAlias : GenericInput,  IEquatable<DAGArrayInputAlias>, IValidatableObject
    {
        ...
        public DAGArrayInputAlias(List<string> platform = default(List<string>), List<IOAliasHandler> handler = default(List<IOAliasHandler>), List<object> _default = default(List<object>), bool required = false, Object spec = default(Object), ItemType? itemsType = default(ItemType?), string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string)) : base(name, annotations, description)
        {
