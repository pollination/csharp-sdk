...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DAGArrayInputAlias :  IEquatable<DAGArrayInputAlias>, IValidatableObject
    {
        /// <summary>
        ...
        (
           ...
           Dictionary<string, string> annotations= default, List<object> _default= default, string description= default, ItemType? itemsType= default, bool required = false, Object spec= default // Optional parameters
        )// BaseClass
        {
            // to ensure "handler" is required (not null)
            if (handler == null)
            {
                throw new InvalidDataException("handler is a required property for DAGArrayInputAlias and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGArrayInputAlias and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (platform == null)
            {
                throw new InvalidDataException("platform is a required property for DAGArrayInputAlias and cannot be null");
            }
            else
            {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DAGArrayInputAlias {\n");
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGArrayInputAlias>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>DAGArrayInputAlias object</returns>
        public DAGArrayInputAlias DuplicateDAGArrayInputAlias()
        {
