...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class InputFolderReference :  IEquatable<InputFolderReference>, IValidatableObject
    {
        /// <summary>
        ...
        )// BaseClass
        {
            ...
            if (variable == null)
            {
                throw new InvalidDataException("variable is a required property for InputFolderReference and cannot be null");
            }
            else
            {
        ...
        {
            var obj = JsonConvert.DeserializeObject<InputFolderReference>(json, JsonSetting.ConvertSetting);
            return obj;
        }
