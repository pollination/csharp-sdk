...
namespace PollinationSDK
{
    ...
    /// </summary>
    [DataContract(Name = "TeamMemberList")]
    public partial class TeamMemberList : OpenAPIGenBaseModel, IEquatable<TeamMemberList>, IValidatableObject
    {
        ...
        (
           int page, int perPage, int pageCount, int totalCount, List<TeamMember> resources, // Required parameters
        ...
        ) : base()// BaseClass
        {
            ...
            this.Resources = resources ?? throw new ArgumentNullException("resources is a required property for TeamMemberList and cannot be null");
        ...
        public override string Type { get; protected internal set; }  = "TeamMemberList";
        ...
        {
            var obj = JsonConvert.DeserializeObject<TeamMemberList>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>TeamMemberList object</returns>
        public virtual TeamMemberList DuplicateTeamMemberList()
        {
        ...
        {
            return DuplicateTeamMemberList();
        }
