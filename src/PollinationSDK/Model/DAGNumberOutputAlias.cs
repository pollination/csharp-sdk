...
namespace PollinationSDK.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DAGNumberOutputAlias :  IEquatable<DAGNumberOutputAlias>, IValidatableObject
    {
        /// <summary>
        ...
        )// BaseClass
        {
            ...
            if (handler == null)
            {
                throw new InvalidDataException("handler is a required property for DAGNumberOutputAlias and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for DAGNumberOutputAlias and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (platform == null)
            {
                throw new InvalidDataException("platform is a required property for DAGNumberOutputAlias and cannot be null");
            }
            else
            {
        ...
        {
            var obj = JsonConvert.DeserializeObject<DAGNumberOutputAlias>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>DAGNumberOutputAlias object</returns>
        public DAGNumberOutputAlias DuplicateDAGNumberOutputAlias()
        {
