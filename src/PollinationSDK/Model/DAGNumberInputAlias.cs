...
namespace PollinationSDK.Model
{
    ...
    public partial class DAGNumberInputAlias : GenericInput,  IEquatable<DAGNumberInputAlias>, IValidatableObject
    {
        ...
        public DAGNumberInputAlias(List<string> platform = default(List<string>), List<IOAliasHandler> handler = default(List<IOAliasHandler>), double _default = default(double), bool required = false, Object spec = default(Object), string name = default(string), Dictionary<string, string> annotations = default(Dictionary<string, string>), string description = default(string)) : base(name, annotations, description)
        {
