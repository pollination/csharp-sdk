...
namespace PollinationSDK
{
    ...
    /// </summary>
    [DataContract(Name = "RecipeInterfaceList")]
    public partial class RecipeInterfaceList : OpenAPIGenBaseModel, IEquatable<RecipeInterfaceList>, IValidatableObject
    {
        /// <summary>
        ...
        (
           int page, int perPage, int pageCount, int totalCount, List<RecipeInterface> resources, // Required parameters
        ...
        ) : base()// BaseClass
        {
            ...
            this.Resources = resources ?? throw new ArgumentNullException("resources is a required property for RecipeInterfaceList and cannot be null");
        ...
        public override string Type { get; protected set; }  = "RecipeInterfaceList";
        ...
        {
            var obj = JsonConvert.DeserializeObject<RecipeInterfaceList>(json, JsonSetting.AnyOfConvertSetting);
            if (obj == null)
                return null;
        ...
        /// </summary>
        /// <returns>RecipeInterfaceList object</returns>
        public virtual RecipeInterfaceList DuplicateRecipeInterfaceList()
        {
        ...
        {
            return DuplicateRecipeInterfaceList();
        }
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            // Type (string) pattern
            Regex regexType = new Regex(@"^RecipeInterfaceList$", RegexOptions.CultureInvariant);
