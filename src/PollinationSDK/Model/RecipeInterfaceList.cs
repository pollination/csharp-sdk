...
namespace PollinationSDK.Model
{
    ...
    public partial class RecipeInterfaceList : OpenAPIGenBaseModel,  IEquatable<RecipeInterfaceList>, IValidatableObject
    {
        ...
        public RecipeInterfaceList(int page = default(int), int perPage = default(int), int pageCount = default(int), int totalCount = default(int), List<RecipeInterface> resources = default(List<RecipeInterface>), int nextPage = default(int)) : base()
        {
