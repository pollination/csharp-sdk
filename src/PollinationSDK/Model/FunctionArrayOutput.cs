...
namespace PollinationSDK.Model
{
    ...
    public partial class FunctionArrayOutput :  IEquatable<FunctionArrayOutput>, IValidatableObject
    {
        ...
        )// BaseClass
        {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for FunctionArrayOutput and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (path == null)
            {
                throw new InvalidDataException("path is a required property for FunctionArrayOutput and cannot be null");
            }
            else
            {
                this.Path = path;
        ...
        {
            var obj = JsonConvert.DeserializeObject<FunctionArrayOutput>(json, JsonSetting.ConvertSetting);
            return obj;
        }
        ...
        /// </summary>
        /// <returns>FunctionArrayOutput object</returns>
        public FunctionArrayOutput DuplicateFunctionArrayOutput()
        {
