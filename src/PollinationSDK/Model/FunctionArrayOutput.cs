...
namespace PollinationSDK
{
    ...
    public partial class FunctionArrayOutput : IEquatable<FunctionArrayOutput>, IValidatableObject
    {
        /// <summary>
        ...
        (
           ...
           Dictionary<string, string> annotations= default, string description= default, ItemType itemsType= ItemType.String, bool required = true // Optional parameters
        )// BaseClass
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for FunctionArrayOutput and cannot be null");
            // to ensure "path" is required (not null)
            this.Path = path ?? throw new ArgumentNullException("path is a required property for FunctionArrayOutput and cannot be null");
        ...
        public string Type { get; protected internal set; }  = "FunctionArrayOutput";
