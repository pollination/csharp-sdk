...
namespace PollinationSDK.Api
{
    ...
    public interface IApplicationsApi : IApiAccessor
    {
        ...
        /// <param name="deployed">Filter by deployed applications (optional)</param>
        ...
        ApplicationList ListApplications (string search = default, List<string> ids = default, List<string> names = default, List<string> owner = default, bool? _public = default, bool? deployed = default, List<string> permissions = default, List<string> keywords = default, ApplicationSortKey? sortBy = default, SortEnum? sortOrder = default, int? page = default, int? perPage = default);
        ...
        ApiResponse<ApplicationList> ListApplicationsWithHttpInfo (string search = default, List<string> ids = default, List<string> names = default, List<string> owner = default, bool? _public = default, bool? deployed = default, List<string> permissions = default, List<string> keywords = default, ApplicationSortKey? sortBy = default, SortEnum? sortOrder = default, int? page = default, int? perPage = default);
        /// <summary>
        ...
        object RestartApplicationDeployment (string owner, string slug);
        ...
        ApiResponse<object> RestartApplicationDeploymentWithHttpInfo (string owner, string slug);
        /// <summary>
        ...
        System.Threading.Tasks.Task<ApplicationList> ListApplicationsAsync (string search = default, List<string> ids = default, List<string> names = default, List<string> owner = default, bool? _public = default, bool? deployed = default, List<string> permissions = default, List<string> keywords = default, ApplicationSortKey? sortBy = default, SortEnum? sortOrder = default, int? page = default, int? perPage = default, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<object> RestartApplicationDeploymentAsync (string owner, string slug, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<object>> RestartApplicationDeploymentWithHttpInfoAsync (string owner, string slug, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Update a Application
        /// </summary>
        /// <remarks>
    ...
    public partial class ApplicationsApi : IApplicationsApi
    {
        ...
        {
             ApiResponse<ApplicationList> localVarResponse = ListApplicationsWithHttpInfo(search, ids, names, owner, _public, deployed, permissions, keywords, sortBy, sortOrder, page, perPage);
             return localVarResponse.Data;
        }
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>ApiResponse of ApplicationList</returns>
        public ApiResponse<ApplicationList> ListApplicationsWithHttpInfo (string search = default, List<string> ids = default, List<string> names = default, List<string> owner = default, bool? _public = default, bool? deployed = default, List<string> permissions = default, List<string> keywords = default, ApplicationSortKey? sortBy = default, SortEnum? sortOrder = default, int? page = default, int? perPage = default)
        {
            ...
            if (deployed != null) localVarQueryParams.AddRange(this.Configuration.ApiClient.ParameterToKeyValuePairs("", "deployed", deployed)); // query parameter
        ...
        {
             ApiResponse<ApplicationList> localVarResponse = await ListApplicationsWithHttpInfoAsync(search, ids, names, owner, _public, deployed, permissions, keywords, sortBy, sortOrder, page, perPage, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="slug"></param>
        /// <returns>object</returns>
        public object RestartApplicationDeployment (string owner, string slug)
        {
             ApiResponse<object> localVarResponse = RestartApplicationDeploymentWithHttpInfo(owner, slug);
             return localVarResponse.Data;
        }
        ...
        /// <param name="slug"></param>
        /// <returns>ApiResponse of object</returns>
        public ApiResponse<object> RestartApplicationDeploymentWithHttpInfo (string owner, string slug)
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
                throw new ApiException(400, "Missing required parameter 'owner' when calling ApplicationsApi->RestartApplicationDeployment");
            // verify the required parameter 'slug' is set
            if (slug == null)
                throw new ApiException(400, "Missing required parameter 'slug' when calling ApplicationsApi->RestartApplicationDeployment");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("RestartApplicationDeployment", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of object</returns>
        public async System.Threading.Tasks.Task<object> RestartApplicationDeploymentAsync (string owner, string slug, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<object> localVarResponse = await RestartApplicationDeploymentWithHttpInfoAsync(owner, slug, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<object>> RestartApplicationDeploymentWithHttpInfoAsync (string owner, string slug, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
                throw new ApiException(400, "Missing required parameter 'owner' when calling ApplicationsApi->RestartApplicationDeployment");
