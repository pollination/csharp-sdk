...
namespace PollinationSDK.Api
{
    ...
    public interface IApplicationsApi : IApiAccessor
    {
        ...
        ApplicationList ListApplications (string search = default, List<string> ids = default, List<string> names = default, List<string> owner = default, bool? _public = default, List<string> permissions = default, ApplicationSortKey? sortBy = default, SortEnum? sortOrder = default, int? page = default, int? perPage = default);
        ...
        ApiResponse<ApplicationList> ListApplicationsWithHttpInfo (string search = default, List<string> ids = default, List<string> names = default, List<string> owner = default, bool? _public = default, List<string> permissions = default, ApplicationSortKey? sortBy = default, SortEnum? sortOrder = default, int? page = default, int? perPage = default);
        /// <summary>
        ...
        System.Threading.Tasks.Task<ApplicationList> ListApplicationsAsync (string search = default, List<string> ids = default, List<string> names = default, List<string> owner = default, bool? _public = default, List<string> permissions = default, ApplicationSortKey? sortBy = default, SortEnum? sortOrder = default, int? page = default, int? perPage = default, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class ApplicationsApi : IApplicationsApi
    {
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>ApplicationList</returns>
        public ApplicationList ListApplications (string search = default, List<string> ids = default, List<string> names = default, List<string> owner = default, bool? _public = default, List<string> permissions = default, ApplicationSortKey? sortBy = default, SortEnum? sortOrder = default, int? page = default, int? perPage = default)
        {
             ApiResponse<ApplicationList> localVarResponse = ListApplicationsWithHttpInfo(search, ids, names, owner, _public, permissions, sortBy, sortOrder, page, perPage);
             return localVarResponse.Data;
        }
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>ApiResponse of ApplicationList</returns>
        public ApiResponse<ApplicationList> ListApplicationsWithHttpInfo (string search = default, List<string> ids = default, List<string> names = default, List<string> owner = default, bool? _public = default, List<string> permissions = default, ApplicationSortKey? sortBy = default, SortEnum? sortOrder = default, int? page = default, int? perPage = default)
        {
        ...
        {
             ApiResponse<ApplicationList> localVarResponse = await ListApplicationsWithHttpInfoAsync(search, ids, names, owner, _public, permissions, sortBy, sortOrder, page, perPage, cancellationToken);
             return localVarResponse.Data;
