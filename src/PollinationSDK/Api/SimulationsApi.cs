...
namespace PollinationSDK.Api
{
    ...
    public interface ISimulationsApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<CreatedContent> CreateSimulationAsync (string owner, string name, SubmitSimulationDto submitSimulationDto, string authorization = default(string), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<CreatedContent>> CreateSimulationWithHttpInfoAsync (string owner, string name, SubmitSimulationDto submitSimulationDto, string authorization = default(string), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Download an artifact from the simulation folder
        /// </summary>
        /// <remarks>
    ...
    public partial class SimulationsApi : ISimulationsApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of CreatedContent</returns>
        public async System.Threading.Tasks.Task<CreatedContent> CreateSimulationAsync (string owner, string name, SubmitSimulationDto submitSimulationDto, string authorization = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<CreatedContent> localVarResponse = await CreateSimulationWithHttpInfoAsync(owner, name, submitSimulationDto, authorization, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (CreatedContent)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CreatedContent>> CreateSimulationWithHttpInfoAsync (string owner, string name, SubmitSimulationDto submitSimulationDto, string authorization = default(string), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
                throw new ApiException(400, "Missing required parameter 'owner' when calling SimulationsApi->CreateSimulation");
