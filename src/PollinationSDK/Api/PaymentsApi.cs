...
namespace PollinationSDK.Api
{
    ...
    public interface IPaymentsApi : IApiAccessor
    {
        ...
        ApiResponse<Subscription> AddSubscriptionItemsWithHttpInfo (string accountName, SubscriptionCreate subscriptionCreate);
        /// <summary>
        /// Add Payment Method
        /// </summary>
        /// <remarks>
        ...
        object DeleteSubscriptionItem (string accountName, string itemId);
        ...
        ApiResponse<object> DeleteSubscriptionItemWithHttpInfo (string accountName, string itemId);
        /// <summary>
        /// Get Inventory
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<Subscription> AddSubscriptionItemsAsync (string accountName, SubscriptionCreate subscriptionCreate, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<Subscription>> AddSubscriptionItemsWithHttpInfoAsync (string accountName, SubscriptionCreate subscriptionCreate, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Add Payment Method
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<object> DeleteSubscriptionItemAsync (string accountName, string itemId, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<object>> DeleteSubscriptionItemWithHttpInfoAsync (string accountName, string itemId, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Get Inventory
        /// </summary>
        /// <remarks>
    ...
    public partial class PaymentsApi : IPaymentsApi
    {
        ...
        /// <param name="subscriptionCreate"></param>
        /// <returns>Subscription</returns>
        public Subscription AddSubscriptionItems (string accountName, SubscriptionCreate subscriptionCreate)
        {
             ApiResponse<Subscription> localVarResponse = AddSubscriptionItemsWithHttpInfo(accountName, subscriptionCreate);
        ...
        /// <param name="subscriptionCreate"></param>
        /// <returns>ApiResponse of Subscription</returns>
        public ApiResponse<Subscription> AddSubscriptionItemsWithHttpInfo (string accountName, SubscriptionCreate subscriptionCreate)
        {
            // verify the required parameter 'accountName' is set
            if (accountName == null)
                throw new ApiException(400, "Missing required parameter 'accountName' when calling PaymentsApi->AddSubscriptionItems");
            // verify the required parameter 'subscriptionCreate' is set
            if (subscriptionCreate == null)
                throw new ApiException(400, "Missing required parameter 'subscriptionCreate' when calling PaymentsApi->AddSubscriptionItems");
            ...
            {
                Exception exception = ExceptionFactory("AddSubscriptionItems", localVarResponse);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of Subscription</returns>
        public async System.Threading.Tasks.Task<Subscription> AddSubscriptionItemsAsync (string accountName, SubscriptionCreate subscriptionCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<Subscription> localVarResponse = await AddSubscriptionItemsWithHttpInfoAsync(accountName, subscriptionCreate, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (Subscription)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Subscription>> AddSubscriptionItemsWithHttpInfoAsync (string accountName, SubscriptionCreate subscriptionCreate, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'accountName' is set
            if (accountName == null)
                throw new ApiException(400, "Missing required parameter 'accountName' when calling PaymentsApi->AddSubscriptionItems");
        ...
        /// <param name="itemId"></param>
        /// <returns>object</returns>
        public object DeleteSubscriptionItem (string accountName, string itemId)
        {
             ApiResponse<object> localVarResponse = DeleteSubscriptionItemWithHttpInfo(accountName, itemId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="itemId"></param>
        /// <returns>ApiResponse of object</returns>
        public ApiResponse<object> DeleteSubscriptionItemWithHttpInfo (string accountName, string itemId)
        {
            // verify the required parameter 'accountName' is set
            if (accountName == null)
                throw new ApiException(400, "Missing required parameter 'accountName' when calling PaymentsApi->DeleteSubscriptionItem");
            // verify the required parameter 'itemId' is set
            if (itemId == null)
                throw new ApiException(400, "Missing required parameter 'itemId' when calling PaymentsApi->DeleteSubscriptionItem");

            var localVarPath = "/payments/{account_name}/subscription/items/{item_id}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("DeleteSubscriptionItem", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of object</returns>
        public async System.Threading.Tasks.Task<object> DeleteSubscriptionItemAsync (string accountName, string itemId, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<object> localVarResponse = await DeleteSubscriptionItemWithHttpInfoAsync(accountName, itemId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<object>> DeleteSubscriptionItemWithHttpInfoAsync (string accountName, string itemId, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'accountName' is set
            if (accountName == null)
                throw new ApiException(400, "Missing required parameter 'accountName' when calling PaymentsApi->DeleteSubscriptionItem");
