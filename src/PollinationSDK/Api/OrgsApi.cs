...
namespace PollinationSDK.Api
{
    ...
    public interface IOrgsApi : IApiAccessor
    {
        ...
        OrganizationList ListOrgs (List<string> search = default(List<string>), List<string> name = default(List<string>), List<string> member = default(List<string>), int? page = default(int?), int? perPage = default(int?));
        ...
        ApiResponse<OrganizationList> ListOrgsWithHttpInfo (List<string> search = default(List<string>), List<string> name = default(List<string>), List<string> member = default(List<string>), int? page = default(int?), int? perPage = default(int?));
        /// <summary>
        /// Update an Org
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<OrganizationList> ListOrgsAsync (List<string> search = default(List<string>), List<string> name = default(List<string>), List<string> member = default(List<string>), int? page = default(int?), int? perPage = default(int?), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<OrganizationList>> ListOrgsWithHttpInfoAsync (List<string> search = default(List<string>), List<string> name = default(List<string>), List<string> member = default(List<string>), int? page = default(int?), int? perPage = default(int?), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Update an Org
        /// </summary>
        /// <remarks>
    ...
    public partial class OrgsApi : IOrgsApi
    {
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>OrganizationList</returns>
        public OrganizationList ListOrgs (List<string> search = default(List<string>), List<string> name = default(List<string>), List<string> member = default(List<string>), int? page = default(int?), int? perPage = default(int?))
        {
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>ApiResponse of OrganizationList</returns>
        public ApiResponse<OrganizationList> ListOrgsWithHttpInfo (List<string> search = default(List<string>), List<string> name = default(List<string>), List<string> member = default(List<string>), int? page = default(int?), int? perPage = default(int?))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of OrganizationList</returns>
        public async System.Threading.Tasks.Task<OrganizationList> ListOrgsAsync (List<string> search = default(List<string>), List<string> name = default(List<string>), List<string> member = default(List<string>), int? page = default(int?), int? perPage = default(int?), CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (OrganizationList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<OrganizationList>> ListOrgsWithHttpInfoAsync (List<string> search = default(List<string>), List<string> name = default(List<string>), List<string> member = default(List<string>), int? page = default(int?), int? perPage = default(int?), CancellationToken cancellationToken = default(CancellationToken))
        {
