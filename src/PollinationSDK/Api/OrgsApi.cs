...
namespace PollinationSDK.Api
{
    ...
    public interface IOrgsApi : IApiAccessor
    {
        ...
        /// <exception cref="PollinationSDK.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="name"></param>
        /// <returns>ApiResponse of OrgDto</returns>
        ApiResponse<OrgDto> GetOrgWithHttpInfo (string name);
        /// <summary>
        ...
        /// <param name="role"></param>
        /// <returns>ApiResponse of UpdateAccepted</returns>
        ApiResponse<UpdateAccepted> UpsertOrgMemberWithHttpInfo (string name, string username, OrgRoleEnum role);
        ...
        System.Threading.Tasks.Task<CreatedContent> CreateOrgAsync (CreateOrgDto createOrgDto, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<CreatedContent>> CreateOrgWithHttpInfoAsync (CreateOrgDto createOrgDto, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Delete an Org
        /// </summary>
        /// <remarks>
        ...
        /// <param name="name"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of OrgDto</returns>
        System.Threading.Tasks.Task<OrgDto> GetOrgAsync (string name, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="name"></param>
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (OrgDto)</returns>
        System.Threading.Tasks.Task<ApiResponse<OrgDto>> GetOrgWithHttpInfoAsync (string name, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// List an Org&#39;s members
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<OrgMemberDto>> GetOrgMembersAsync (string name, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<OrgMemberDto>>> GetOrgMembersWithHttpInfoAsync (string name, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// List Orgs
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<OrgDto>> ListOrgsAsync (int? page = default(int?), int? perPage = default(int?), List<string> name = default(List<string>), List<string> member = default(List<string>), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<OrgDto>>> ListOrgsWithHttpInfoAsync (int? page = default(int?), int? perPage = default(int?), List<string> name = default(List<string>), List<string> member = default(List<string>), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Update an Org
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<UpdateAccepted> UpdateOrgAsync (string name, PatchOrgDto patchOrgDto, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<UpdateAccepted>> UpdateOrgWithHttpInfoAsync (string name, PatchOrgDto patchOrgDto, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Add or update the role of an Org Member
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of UpdateAccepted</returns>
        System.Threading.Tasks.Task<UpdateAccepted> UpsertOrgMemberAsync (string name, string username, OrgRoleEnum role, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (UpdateAccepted)</returns>
        System.Threading.Tasks.Task<ApiResponse<UpdateAccepted>> UpsertOrgMemberWithHttpInfoAsync (string name, string username, OrgRoleEnum role, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class OrgsApi : IOrgsApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of CreatedContent</returns>
        public async System.Threading.Tasks.Task<CreatedContent> CreateOrgAsync (CreateOrgDto createOrgDto, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<CreatedContent> localVarResponse = await CreateOrgWithHttpInfoAsync(createOrgDto, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (CreatedContent)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<CreatedContent>> CreateOrgWithHttpInfoAsync (CreateOrgDto createOrgDto, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'createOrgDto' is set
            if (createOrgDto == null)
                throw new ApiException(400, "Missing required parameter 'createOrgDto' when calling OrgsApi->CreateOrg");
        ...
        /// <param name="name"></param>
        /// <returns>OrgDto</returns>
        public OrgDto GetOrg (string name)
        {
             ApiResponse<OrgDto> localVarResponse = GetOrgWithHttpInfo(name);
             return localVarResponse.Data;
        }
        ...
        /// <param name="name"></param>
        /// <returns>ApiResponse of OrgDto</returns>
        public ApiResponse<OrgDto> GetOrgWithHttpInfo (string name)
        {
            // verify the required parameter 'name' is set
            if (name == null)
            ...
            return new ApiResponse<OrgDto>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (OrgDto) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(OrgDto)));
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of OrgDto</returns>
        public async System.Threading.Tasks.Task<OrgDto> GetOrgAsync (string name, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<OrgDto> localVarResponse = await GetOrgWithHttpInfoAsync(name, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (OrgDto)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<OrgDto>> GetOrgWithHttpInfoAsync (string name, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling OrgsApi->GetOrg");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of List&lt;OrgMemberDto&gt;</returns>
        public async System.Threading.Tasks.Task<List<OrgMemberDto>> GetOrgMembersAsync (string name, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<List<OrgMemberDto>> localVarResponse = await GetOrgMembersWithHttpInfoAsync(name, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (List&lt;OrgMemberDto&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<OrgMemberDto>>> GetOrgMembersWithHttpInfoAsync (string name, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling OrgsApi->GetOrgMembers");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of List&lt;OrgDto&gt;</returns>
        public async System.Threading.Tasks.Task<List<OrgDto>> ListOrgsAsync (int? page = default(int?), int? perPage = default(int?), List<string> name = default(List<string>), List<string> member = default(List<string>), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<List<OrgDto>> localVarResponse = await ListOrgsWithHttpInfoAsync(page, perPage, name, member, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (List&lt;OrgDto&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<OrgDto>>> ListOrgsWithHttpInfoAsync (int? page = default(int?), int? perPage = default(int?), List<string> name = default(List<string>), List<string> member = default(List<string>), CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of UpdateAccepted</returns>
        public async System.Threading.Tasks.Task<UpdateAccepted> UpdateOrgAsync (string name, PatchOrgDto patchOrgDto, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<UpdateAccepted> localVarResponse = await UpdateOrgWithHttpInfoAsync(name, patchOrgDto, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (UpdateAccepted)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UpdateAccepted>> UpdateOrgWithHttpInfoAsync (string name, PatchOrgDto patchOrgDto, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling OrgsApi->UpdateOrg");
        ...
        /// <param name="role"></param>
        /// <returns>UpdateAccepted</returns>
        public UpdateAccepted UpsertOrgMember (string name, string username, OrgRoleEnum role)
        {
        ...
        /// <param name="role"></param>
        /// <returns>ApiResponse of UpdateAccepted</returns>
        public ApiResponse<UpdateAccepted> UpsertOrgMemberWithHttpInfo (string name, string username, OrgRoleEnum role)
        {
            // verify the required parameter 'name' is set
            if (name == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of UpdateAccepted</returns>
        public async System.Threading.Tasks.Task<UpdateAccepted> UpsertOrgMemberAsync (string name, string username, OrgRoleEnum role, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (UpdateAccepted)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UpdateAccepted>> UpsertOrgMemberWithHttpInfoAsync (string name, string username, OrgRoleEnum role, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling OrgsApi->UpsertOrgMember");
