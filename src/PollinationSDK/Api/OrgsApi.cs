...
namespace PollinationSDK.Api
{
    ...
    public interface IOrgsApi : IApiAccessor
    {
        ...
        OrganizationList ListOrgs (int page = default, int perPage = default, List<string> name = default, List<string> member = default);
        ...
        ApiResponse<OrganizationList> ListOrgsWithHttpInfo (int page = default, int perPage = default, List<string> name = default, List<string> member = default);
        /// <summary>
        /// Update an Org
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<OrganizationList> ListOrgsAsync (int page = default, int perPage = default, List<string> name = default, List<string> member = default, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<OrganizationList>> ListOrgsWithHttpInfoAsync (int page = default, int perPage = default, List<string> name = default, List<string> member = default, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Update an Org
        /// </summary>
        /// <remarks>
    ...
    public partial class OrgsApi : IOrgsApi
    {
        ...
        /// <param name="member">The ID of a user (optional)</param>
        /// <returns>OrganizationList</returns>
        public OrganizationList ListOrgs (int page = default, int perPage = default, List<string> name = default, List<string> member = default)
        {
        ...
        /// <param name="member">The ID of a user (optional)</param>
        /// <returns>ApiResponse of OrganizationList</returns>
        public ApiResponse<OrganizationList> ListOrgsWithHttpInfo (int page = default, int perPage = default, List<string> name = default, List<string> member = default)
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of OrganizationList</returns>
        public async System.Threading.Tasks.Task<OrganizationList> ListOrgsAsync (int page = default, int perPage = default, List<string> name = default, List<string> member = default, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (OrganizationList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<OrganizationList>> ListOrgsWithHttpInfoAsync (int page = default, int perPage = default, List<string> name = default, List<string> member = default, CancellationToken cancellationToken = default(CancellationToken))
        {
