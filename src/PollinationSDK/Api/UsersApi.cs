...
namespace PollinationSDK.Api
{
    ...
    public interface IUsersApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<PublicUserDto> GetOneUserAsync (string name, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<PublicUserDto>> GetOneUserWithHttpInfoAsync (string name, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// List Users
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<List<PublicUserDto>> ListUsersAsync (int? page = default(int?), int? perPage = default(int?), string name = default(string), string username = default(string), List<string> id = default(List<string>), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<List<PublicUserDto>>> ListUsersWithHttpInfoAsync (int? page = default(int?), int? perPage = default(int?), string name = default(string), string username = default(string), List<string> id = default(List<string>), CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class UsersApi : IUsersApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of PublicUserDto</returns>
        public async System.Threading.Tasks.Task<PublicUserDto> GetOneUserAsync (string name, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<PublicUserDto> localVarResponse = await GetOneUserWithHttpInfoAsync(name, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (PublicUserDto)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PublicUserDto>> GetOneUserWithHttpInfoAsync (string name, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling UsersApi->GetOneUser");
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of List&lt;PublicUserDto&gt;</returns>
        public async System.Threading.Tasks.Task<List<PublicUserDto>> ListUsersAsync (int? page = default(int?), int? perPage = default(int?), string name = default(string), string username = default(string), List<string> id = default(List<string>), CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<List<PublicUserDto>> localVarResponse = await ListUsersWithHttpInfoAsync(page, perPage, name, username, id, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (List&lt;PublicUserDto&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<PublicUserDto>>> ListUsersWithHttpInfoAsync (int? page = default(int?), int? perPage = default(int?), string name = default(string), string username = default(string), List<string> id = default(List<string>), CancellationToken cancellationToken = default(CancellationToken))
        {
