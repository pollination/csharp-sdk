...
namespace PollinationSDK.Api
{
    ...
    public interface IArtifactsApi : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<object> DownloadArtifactAsync (string owner, string name, string path = default, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<object>> DownloadArtifactWithHttpInfoAsync (string owner, string name, string path = default, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// List artifacts in a project folder
        /// </summary>
        /// <remarks>
    ...
    public partial class ArtifactsApi : IArtifactsApi
    {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of object</returns>
        public async System.Threading.Tasks.Task<object> DownloadArtifactAsync (string owner, string name, string path = default, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<object>> DownloadArtifactWithHttpInfoAsync (string owner, string name, string path = default, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
                throw new ApiException(400, "Missing required parameter 'owner' when calling ArtifactsApi->DownloadArtifact");
