...
namespace PollinationSDK.Api
{
    ...
    public interface IAPITokensApi : IApiAccessor
    {
        ...
        APITokenList ListTokens (int? page = default(int?), int? perPage = default(int?));
        ...
        ApiResponse<APITokenList> ListTokensWithHttpInfo (int? page = default(int?), int? perPage = default(int?));
        /// <summary>
        ...
        System.Threading.Tasks.Task<APITokenList> ListTokensAsync (int? page = default(int?), int? perPage = default(int?), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<APITokenList>> ListTokensWithHttpInfoAsync (int? page = default(int?), int? perPage = default(int?), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Regenerate an API token
        /// </summary>
        /// <remarks>
    ...
    public partial class APITokensApi : IAPITokensApi
    {
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>APITokenList</returns>
        public APITokenList ListTokens (int? page = default(int?), int? perPage = default(int?))
        {
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>ApiResponse of APITokenList</returns>
        public ApiResponse<APITokenList> ListTokensWithHttpInfo (int? page = default(int?), int? perPage = default(int?))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of APITokenList</returns>
        public async System.Threading.Tasks.Task<APITokenList> ListTokensAsync (int? page = default(int?), int? perPage = default(int?), CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (APITokenList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<APITokenList>> ListTokensWithHttpInfoAsync (int? page = default(int?), int? perPage = default(int?), CancellationToken cancellationToken = default(CancellationToken))
        {
