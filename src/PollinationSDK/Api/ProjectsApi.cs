...
namespace PollinationSDK.Api
{
    ...
    public interface IProjectsApi : IApiAccessor
    {
        ...
        RepositoryList GetProjectRecipeRepositories (string owner, string name, string search = default, int? page = default, int? perPage = default);
        ...
        ApiResponse<RepositoryList> GetProjectRecipeRepositoriesWithHttpInfo (string owner, string name, string search = default, int? page = default, int? perPage = default);
        /// <summary>
        ...
        System.Threading.Tasks.Task<RepositoryList> GetProjectRecipeRepositoriesAsync (string owner, string name, string search = default, int? page = default, int? perPage = default, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<RepositoryList>> GetProjectRecipeRepositoriesWithHttpInfoAsync (string owner, string name, string search = default, int? page = default, int? perPage = default, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Get project recipe versions
        /// </summary>
        /// <remarks>
    ...
    public partial class ProjectsApi : IProjectsApi
    {
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>RepositoryList</returns>
        public RepositoryList GetProjectRecipeRepositories (string owner, string name, string search = default, int? page = default, int? perPage = default)
        {
             ApiResponse<RepositoryList> localVarResponse = GetProjectRecipeRepositoriesWithHttpInfo(owner, name, search, page, perPage);
             return localVarResponse.Data;
        }
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>ApiResponse of RepositoryList</returns>
        public ApiResponse<RepositoryList> GetProjectRecipeRepositoriesWithHttpInfo (string owner, string name, string search = default, int? page = default, int? perPage = default)
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
                throw new ApiException(400, "Missing required parameter 'owner' when calling ProjectsApi->GetProjectRecipeRepositories");
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling ProjectsApi->GetProjectRecipeRepositories");

            var localVarPath = "/projects/{owner}/{name}/recipes/repositories";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetProjectRecipeRepositories", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of RepositoryList</returns>
        public async System.Threading.Tasks.Task<RepositoryList> GetProjectRecipeRepositoriesAsync (string owner, string name, string search = default, int? page = default, int? perPage = default, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<RepositoryList> localVarResponse = await GetProjectRecipeRepositoriesWithHttpInfoAsync(owner, name, search, page, perPage, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (RepositoryList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<RepositoryList>> GetProjectRecipeRepositoriesWithHttpInfoAsync (string owner, string name, string search = default, int? page = default, int? perPage = default, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
                throw new ApiException(400, "Missing required parameter 'owner' when calling ProjectsApi->GetProjectRecipeRepositories");
