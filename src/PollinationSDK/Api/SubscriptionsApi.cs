...
namespace PollinationSDK.Api
{
    ...
    public interface ISubscriptionsApi : IApiAccessor
    {
        ...
        /// <param name="accountName"></param>
        /// <returns>ApiResponse of PollinationSubscription</returns>
        ApiResponse<PollinationSubscription> GetUpcomingPollinationSubscriptionWithHttpInfo (string accountName);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of PollinationSubscription</returns>
        System.Threading.Tasks.Task<PollinationSubscription> GetUpcomingPollinationSubscriptionAsync (string accountName, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (PollinationSubscription)</returns>
        System.Threading.Tasks.Task<ApiResponse<PollinationSubscription>> GetUpcomingPollinationSubscriptionWithHttpInfoAsync (string accountName, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class SubscriptionsApi : ISubscriptionsApi
    {
        ...
        /// <param name="accountName"></param>
        /// <returns>PollinationSubscription</returns>
        public PollinationSubscription GetUpcomingPollinationSubscription (string accountName)
        {
             ApiResponse<PollinationSubscription> localVarResponse = GetUpcomingPollinationSubscriptionWithHttpInfo(accountName);
             return localVarResponse.Data;
        }
        ...
        /// <param name="accountName"></param>
        /// <returns>ApiResponse of PollinationSubscription</returns>
        public ApiResponse<PollinationSubscription> GetUpcomingPollinationSubscriptionWithHttpInfo (string accountName)
        {
            // verify the required parameter 'accountName' is set
            if (accountName == null)
                throw new ApiException(400, "Missing required parameter 'accountName' when calling SubscriptionsApi->GetUpcomingPollinationSubscription");

            var localVarPath = "/subscriptions/{account_name}/upcoming";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetUpcomingPollinationSubscription", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of PollinationSubscription</returns>
        public async System.Threading.Tasks.Task<PollinationSubscription> GetUpcomingPollinationSubscriptionAsync (string accountName, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<PollinationSubscription> localVarResponse = await GetUpcomingPollinationSubscriptionWithHttpInfoAsync(accountName, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (PollinationSubscription)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<PollinationSubscription>> GetUpcomingPollinationSubscriptionWithHttpInfoAsync (string accountName, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'accountName' is set
            if (accountName == null)
                throw new ApiException(400, "Missing required parameter 'accountName' when calling SubscriptionsApi->GetUpcomingPollinationSubscription");
