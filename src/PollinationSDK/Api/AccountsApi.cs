...
namespace PollinationSDK.Api
{
    ...
    public interface IAccountsApi : IApiAccessor
    {
        ...
        QuotaList ListQuotas (string name, List<QuotaType> type = default, bool? exceeded = default, bool? enforced = default, int? page = default, int? perPage = default);
        ...
        ApiResponse<QuotaList> ListQuotasWithHttpInfo (string name, List<QuotaType> type = default, bool? exceeded = default, bool? enforced = default, int? page = default, int? perPage = default);
        ...
        System.Threading.Tasks.Task<QuotaList> ListQuotasAsync (string name, List<QuotaType> type = default, bool? exceeded = default, bool? enforced = default, int? page = default, int? perPage = default, CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<QuotaList>> ListQuotasWithHttpInfoAsync (string name, List<QuotaType> type = default, bool? exceeded = default, bool? enforced = default, int? page = default, int? perPage = default, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class AccountsApi : IAccountsApi
    {
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>QuotaList</returns>
        public QuotaList ListQuotas (string name, List<QuotaType> type = default, bool? exceeded = default, bool? enforced = default, int? page = default, int? perPage = default)
        {
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>ApiResponse of QuotaList</returns>
        public ApiResponse<QuotaList> ListQuotasWithHttpInfo (string name, List<QuotaType> type = default, bool? exceeded = default, bool? enforced = default, int? page = default, int? perPage = default)
        {
            // verify the required parameter 'name' is set
            if (name == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of QuotaList</returns>
        public async System.Threading.Tasks.Task<QuotaList> ListQuotasAsync (string name, List<QuotaType> type = default, bool? exceeded = default, bool? enforced = default, int? page = default, int? perPage = default, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (QuotaList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<QuotaList>> ListQuotasWithHttpInfoAsync (string name, List<QuotaType> type = default, bool? exceeded = default, bool? enforced = default, int? page = default, int? perPage = default, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'name' is set
            if (name == null)
                throw new ApiException(400, "Missing required parameter 'name' when calling AccountsApi->ListQuotas");
