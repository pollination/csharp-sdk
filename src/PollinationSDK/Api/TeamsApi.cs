...
namespace PollinationSDK.Api
{
    ...
    public interface ITeamsApi : IApiAccessor
    {
        ...
        /// <param name="role"></param>
        /// <returns>ApiResponse of UpdateAccepted</returns>
        ApiResponse<UpdateAccepted> UpsertOrgTeamMemberWithHttpInfo (string orgName, string teamSlug, string username, string role);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of UpdateAccepted</returns>
        System.Threading.Tasks.Task<UpdateAccepted> UpsertOrgTeamMemberAsync (string orgName, string teamSlug, string username, string role, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (UpdateAccepted)</returns>
        System.Threading.Tasks.Task<ApiResponse<UpdateAccepted>> UpsertOrgTeamMemberWithHttpInfoAsync (string orgName, string teamSlug, string username, string role, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class TeamsApi : ITeamsApi
    {
        ...
        /// <param name="role"></param>
        /// <returns>UpdateAccepted</returns>
        public UpdateAccepted UpsertOrgTeamMember (string orgName, string teamSlug, string username, string role)
        {
        ...
        /// <param name="role"></param>
        /// <returns>ApiResponse of UpdateAccepted</returns>
        public ApiResponse<UpdateAccepted> UpsertOrgTeamMemberWithHttpInfo (string orgName, string teamSlug, string username, string role)
        {
            // verify the required parameter 'orgName' is set
            if (orgName == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of UpdateAccepted</returns>
        public async System.Threading.Tasks.Task<UpdateAccepted> UpsertOrgTeamMemberAsync (string orgName, string teamSlug, string username, string role, CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (UpdateAccepted)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<UpdateAccepted>> UpsertOrgTeamMemberWithHttpInfoAsync (string orgName, string teamSlug, string username, string role, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'orgName' is set
            if (orgName == null)
                throw new ApiException(400, "Missing required parameter 'orgName' when calling TeamsApi->UpsertOrgTeamMember");
