...
namespace PollinationSDK.Api
{
    ...
    public interface ITeamsApi : IApiAccessor
    {
        ...
        TeamList ListOrgTeams (string orgName, List<string> search = default(List<string>), List<string> name = default(List<string>), List<string> member = default(List<string>), int? page = default(int?), int? perPage = default(int?));
        ...
        ApiResponse<TeamList> ListOrgTeamsWithHttpInfo (string orgName, List<string> search = default(List<string>), List<string> name = default(List<string>), List<string> member = default(List<string>), int? page = default(int?), int? perPage = default(int?));
        /// <summary>
        /// Update a Team
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<TeamList> ListOrgTeamsAsync (string orgName, List<string> search = default(List<string>), List<string> name = default(List<string>), List<string> member = default(List<string>), int? page = default(int?), int? perPage = default(int?), CancellationToken cancellationToken = default(CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<TeamList>> ListOrgTeamsWithHttpInfoAsync (string orgName, List<string> search = default(List<string>), List<string> name = default(List<string>), List<string> member = default(List<string>), int? page = default(int?), int? perPage = default(int?), CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// Update a Team
        /// </summary>
        /// <remarks>
    ...
    public partial class TeamsApi : ITeamsApi
    {
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>TeamList</returns>
        public TeamList ListOrgTeams (string orgName, List<string> search = default(List<string>), List<string> name = default(List<string>), List<string> member = default(List<string>), int? page = default(int?), int? perPage = default(int?))
        {
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>ApiResponse of TeamList</returns>
        public ApiResponse<TeamList> ListOrgTeamsWithHttpInfo (string orgName, List<string> search = default(List<string>), List<string> name = default(List<string>), List<string> member = default(List<string>), int? page = default(int?), int? perPage = default(int?))
        {
            // verify the required parameter 'orgName' is set
            if (orgName == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of TeamList</returns>
        public async System.Threading.Tasks.Task<TeamList> ListOrgTeamsAsync (string orgName, List<string> search = default(List<string>), List<string> name = default(List<string>), List<string> member = default(List<string>), int? page = default(int?), int? perPage = default(int?), CancellationToken cancellationToken = default(CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (TeamList)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<TeamList>> ListOrgTeamsWithHttpInfoAsync (string orgName, List<string> search = default(List<string>), List<string> name = default(List<string>), List<string> member = default(List<string>), int? page = default(int?), int? perPage = default(int?), CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'orgName' is set
            if (orgName == null)
                throw new ApiException(400, "Missing required parameter 'orgName' when calling TeamsApi->ListOrgTeams");
