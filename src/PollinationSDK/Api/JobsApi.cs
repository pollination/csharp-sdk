...
namespace PollinationSDK.Api
{
    ...
    public interface IJobsApi : IApiAccessor
    {
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>object</returns>
        object SearchJobFolder (string owner, string name, string jobId, List<string> path = default, int? page = default, int? perPage = default);
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>ApiResponse of object</returns>
        ApiResponse<object> SearchJobFolderWithHttpInfo (string owner, string name, string jobId, List<string> path = default, int? page = default, int? perPage = default);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of object</returns>
        System.Threading.Tasks.Task<object> SearchJobFolderAsync (string owner, string name, string jobId, List<string> path = default, int? page = default, int? perPage = default, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (object)</returns>
        System.Threading.Tasks.Task<ApiResponse<object>> SearchJobFolderWithHttpInfoAsync (string owner, string name, string jobId, List<string> path = default, int? page = default, int? perPage = default, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class JobsApi : IJobsApi
    {
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>object</returns>
        public object SearchJobFolder (string owner, string name, string jobId, List<string> path = default, int? page = default, int? perPage = default)
        {
             ApiResponse<object> localVarResponse = SearchJobFolderWithHttpInfo(owner, name, jobId, path, page, perPage);
             return localVarResponse.Data;
        }
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>ApiResponse of object</returns>
        public ApiResponse<object> SearchJobFolderWithHttpInfo (string owner, string name, string jobId, List<string> path = default, int? page = default, int? perPage = default)
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of object</returns>
        public async System.Threading.Tasks.Task<object> SearchJobFolderAsync (string owner, string name, string jobId, List<string> path = default, int? page = default, int? perPage = default, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<object> localVarResponse = await SearchJobFolderWithHttpInfoAsync(owner, name, jobId, path, page, perPage, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<object>> SearchJobFolderWithHttpInfoAsync (string owner, string name, string jobId, List<string> path = default, int? page = default, int? perPage = default, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
                throw new ApiException(400, "Missing required parameter 'owner' when calling JobsApi->SearchJobFolder");
