...
namespace PollinationSDK.Api
{
    ...
    public interface IJobsApi : IApiAccessor
    {
        ...
        /// <returns>object</returns>
        object RetryJob (string owner, string name, string jobId, RetryConfig retryConfig);
        ...
        /// <param name="retryConfig"></param>
        /// <returns>ApiResponse of object</returns>
        ApiResponse<object> RetryJobWithHttpInfo (string owner, string name, string jobId, RetryConfig retryConfig);
        /// <summary>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of object</returns>
        System.Threading.Tasks.Task<object> RetryJobAsync (string owner, string name, string jobId, RetryConfig retryConfig, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (object)</returns>
        System.Threading.Tasks.Task<ApiResponse<object>> RetryJobWithHttpInfoAsync (string owner, string name, string jobId, RetryConfig retryConfig, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// List files/folders in a job folder
        /// </summary>
        /// <remarks>
    ...
    public partial class JobsApi : IJobsApi
    {
        ...
        /// <param name="retryConfig"></param>
        /// <returns>object</returns>
        public object RetryJob (string owner, string name, string jobId, RetryConfig retryConfig)
        {
             ApiResponse<object> localVarResponse = RetryJobWithHttpInfo(owner, name, jobId, retryConfig);
             return localVarResponse.Data;
        }
        ...
        /// <param name="retryConfig"></param>
        /// <returns>ApiResponse of object</returns>
        public ApiResponse<object> RetryJobWithHttpInfo (string owner, string name, string jobId, RetryConfig retryConfig)
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of object</returns>
        public async System.Threading.Tasks.Task<object> RetryJobAsync (string owner, string name, string jobId, RetryConfig retryConfig, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<object> localVarResponse = await RetryJobWithHttpInfoAsync(owner, name, jobId, retryConfig, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<object>> RetryJobWithHttpInfoAsync (string owner, string name, string jobId, RetryConfig retryConfig, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
                throw new ApiException(400, "Missing required parameter 'owner' when calling JobsApi->RetryJob");
