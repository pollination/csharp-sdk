...
namespace PollinationSDK.Api
{
    ...
    public interface IJobsApi : IApiAccessor
    {
        ...
        /// <param name="jobId"></param>
        /// <returns>object</returns>
        object RetryJob (string owner, string name, string jobId);
        ...
        /// <param name="jobId"></param>
        /// <returns>ApiResponse of object</returns>
        ApiResponse<object> RetryJobWithHttpInfo (string owner, string name, string jobId);
        /// <summary>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of object</returns>
        System.Threading.Tasks.Task<object> RetryJobAsync (string owner, string name, string jobId, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (object)</returns>
        System.Threading.Tasks.Task<ApiResponse<object>> RetryJobWithHttpInfoAsync (string owner, string name, string jobId, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// List files/folders in a job folder
        /// </summary>
        /// <remarks>
    ...
    public partial class JobsApi : IJobsApi
    {
        ...
        /// <param name="jobId"></param>
        /// <returns>object</returns>
        public object RetryJob (string owner, string name, string jobId)
        {
             ApiResponse<object> localVarResponse = RetryJobWithHttpInfo(owner, name, jobId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="jobId"></param>
        /// <returns>ApiResponse of object</returns>
        public ApiResponse<object> RetryJobWithHttpInfo (string owner, string name, string jobId)
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of object</returns>
        public async System.Threading.Tasks.Task<object> RetryJobAsync (string owner, string name, string jobId, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<object> localVarResponse = await RetryJobWithHttpInfoAsync(owner, name, jobId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<object>> RetryJobWithHttpInfoAsync (string owner, string name, string jobId, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
                throw new ApiException(400, "Missing required parameter 'owner' when calling JobsApi->RetryJob");
