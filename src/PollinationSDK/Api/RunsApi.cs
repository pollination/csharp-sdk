...
namespace PollinationSDK.Api
{
    ...
    public interface IRunsApi : IApiAccessor
    {
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>object</returns>
        object ListRunArtifacts (string owner, string name, string runId, List<string> path = default, int? page = default, int? perPage = default);
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>ApiResponse of object</returns>
        ApiResponse<object> ListRunArtifactsWithHttpInfo (string owner, string name, string runId, List<string> path = default, int? page = default, int? perPage = default);
        /// <summary>
        /// List runs
        /// </summary>
        /// <remarks>
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of object</returns>
        System.Threading.Tasks.Task<object> ListRunArtifactsAsync (string owner, string name, string runId, List<string> path = default, int? page = default, int? perPage = default, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (object)</returns>
        System.Threading.Tasks.Task<ApiResponse<object>> ListRunArtifactsWithHttpInfoAsync (string owner, string name, string runId, List<string> path = default, int? page = default, int? perPage = default, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
        /// List runs
        /// </summary>
        /// <remarks>
    ...
    public partial class RunsApi : IRunsApi
    {
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>object</returns>
        public object ListRunArtifacts (string owner, string name, string runId, List<string> path = default, int? page = default, int? perPage = default)
        {
             ApiResponse<object> localVarResponse = ListRunArtifactsWithHttpInfo(owner, name, runId, path, page, perPage);
             return localVarResponse.Data;
        }
        ...
        /// <param name="perPage">Number of items per page (optional, default to 25)</param>
        /// <returns>ApiResponse of object</returns>
        public ApiResponse<object> ListRunArtifactsWithHttpInfo (string owner, string name, string runId, List<string> path = default, int? page = default, int? perPage = default)
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of object</returns>
        public async System.Threading.Tasks.Task<object> ListRunArtifactsAsync (string owner, string name, string runId, List<string> path = default, int? page = default, int? perPage = default, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<object> localVarResponse = await ListRunArtifactsWithHttpInfoAsync(owner, name, runId, path, page, perPage, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<object>> ListRunArtifactsWithHttpInfoAsync (string owner, string name, string runId, List<string> path = default, int? page = default, int? perPage = default, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
                throw new ApiException(400, "Missing required parameter 'owner' when calling RunsApi->ListRunArtifacts");
