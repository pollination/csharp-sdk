...
namespace PollinationSDK.Api
{
    ...
    public interface IRunsApi : IApiAccessor
    {
        ...
        /// <param name="runId"></param>
        /// <returns>object</returns>
        object RetryRun (string owner, string name, string runId);
        ...
        /// <param name="runId"></param>
        /// <returns>ApiResponse of object</returns>
        ApiResponse<object> RetryRunWithHttpInfo (string owner, string name, string runId);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of object</returns>
        System.Threading.Tasks.Task<object> RetryRunAsync (string owner, string name, string runId, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (object)</returns>
        System.Threading.Tasks.Task<ApiResponse<object>> RetryRunWithHttpInfoAsync (string owner, string name, string runId, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class RunsApi : IRunsApi
    {
        ...
        /// <param name="runId"></param>
        /// <returns>object</returns>
        public object RetryRun (string owner, string name, string runId)
        {
             ApiResponse<object> localVarResponse = RetryRunWithHttpInfo(owner, name, runId);
             return localVarResponse.Data;
        }
        ...
        /// <param name="runId"></param>
        /// <returns>ApiResponse of object</returns>
        public ApiResponse<object> RetryRunWithHttpInfo (string owner, string name, string runId)
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of object</returns>
        public async System.Threading.Tasks.Task<object> RetryRunAsync (string owner, string name, string runId, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<object> localVarResponse = await RetryRunWithHttpInfoAsync(owner, name, runId, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<object>> RetryRunWithHttpInfoAsync (string owner, string name, string runId, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
                throw new ApiException(400, "Missing required parameter 'owner' when calling RunsApi->RetryRun");
