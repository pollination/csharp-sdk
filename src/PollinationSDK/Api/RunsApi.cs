...
namespace PollinationSDK.Api
{
    ...
    public interface IRunsApi : IApiAccessor
    {
        ...
        /// <returns>object</returns>
        object RetryRun (string owner, string name, string runId, RetryConfig retryConfig);
        ...
        /// <param name="retryConfig"></param>
        /// <returns>ApiResponse of object</returns>
        ApiResponse<object> RetryRunWithHttpInfo (string owner, string name, string runId, RetryConfig retryConfig);
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of object</returns>
        System.Threading.Tasks.Task<object> RetryRunAsync (string owner, string name, string runId, RetryConfig retryConfig, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (object)</returns>
        System.Threading.Tasks.Task<ApiResponse<object>> RetryRunWithHttpInfoAsync (string owner, string name, string runId, RetryConfig retryConfig, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public partial class RunsApi : IRunsApi
    {
        ...
        /// <param name="retryConfig"></param>
        /// <returns>object</returns>
        public object RetryRun (string owner, string name, string runId, RetryConfig retryConfig)
        {
             ApiResponse<object> localVarResponse = RetryRunWithHttpInfo(owner, name, runId, retryConfig);
             return localVarResponse.Data;
        }
        ...
        /// <param name="retryConfig"></param>
        /// <returns>ApiResponse of object</returns>
        public ApiResponse<object> RetryRunWithHttpInfo (string owner, string name, string runId, RetryConfig retryConfig)
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of object</returns>
        public async System.Threading.Tasks.Task<object> RetryRunAsync (string owner, string name, string runId, RetryConfig retryConfig, CancellationToken cancellationToken = default(CancellationToken))
        {
             ApiResponse<object> localVarResponse = await RetryRunWithHttpInfoAsync(owner, name, runId, retryConfig, cancellationToken);
             return localVarResponse.Data;
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel request (optional) </param>
        /// <returns>Task of ApiResponse (object)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<object>> RetryRunWithHttpInfoAsync (string owner, string name, string runId, RetryConfig retryConfig, CancellationToken cancellationToken = default(CancellationToken))
        {
            // verify the required parameter 'owner' is set
            if (owner == null)
                throw new ApiException(400, "Missing required parameter 'owner' when calling RunsApi->RetryRun");
