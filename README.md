...
- API version: 0.17.0-staging
- SDK version: 0.17.0-staging
...
*PaymentsApi* | [**AddPaymentMethodPaymentsAccountNameMethodsPost**](docs/PaymentsApi.md#addpaymentmethodpaymentsaccountnamemethodspost) | **POST** /payments/{account_name}/methods | Add Payment Method
*PaymentsApi* | [**CreateSubscriptionPaymentsAccountNameSubscriptionPost**](docs/PaymentsApi.md#createsubscriptionpaymentsaccountnamesubscriptionpost) | **POST** /payments/{account_name}/subscription | Create Subscription
*PaymentsApi* | [**GetInventoryPaymentsInventoryGet**](docs/PaymentsApi.md#getinventorypaymentsinventoryget) | **GET** /payments/inventory | Get Inventory
*PaymentsApi* | [**GetPaymentMethodsPaymentsAccountNameMethodsGet**](docs/PaymentsApi.md#getpaymentmethodspaymentsaccountnamemethodsget) | **GET** /payments/{account_name}/methods | Get Payment Methods
*PaymentsApi* | [**GetSubscriptionPaymentsAccountNameSubscriptionGet**](docs/PaymentsApi.md#getsubscriptionpaymentsaccountnamesubscriptionget) | **GET** /payments/{account_name}/subscription | Get Subscription
