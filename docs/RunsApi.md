...
> AnyType ListRunArtifacts (string owner, string name, string runId, List<string> path = null, int? page = null, int? perPage = null)
...
namespace Example
{
    public class ListRunArtifactsExample
    {
        public static void Main()
        {
            ...
            {
                // List artifacts in a run folder
                AnyType result = apiInstance.ListRunArtifacts(owner, name, runId, path, page, perPage);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
