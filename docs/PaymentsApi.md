...
------------- | ------------- | -------------
[**AddSubscriptionItems**](PaymentsApi.md#addsubscriptionitems) | **PUT** /payments/{account_name}/subscription | Update Subscription
...
[**DeleteSubscriptionItem**](PaymentsApi.md#deletesubscriptionitem) | **DELETE** /payments/{account_name}/subscription/items/{item_id} | Delete Item
...
> Subscription AddSubscriptionItems (string accountName, SubscriptionCreate subscriptionCreate)
...
namespace Example
{
    public class AddSubscriptionItemsExample
    {
        public static void Main()
        {
            ...
            {
                // Update Subscription
                Subscription result = apiInstance.AddSubscriptionItems(accountName, subscriptionCreate);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling PaymentsApi.AddSubscriptionItems: " + e.Message );
...
> AnyType DeleteSubscriptionItem (string accountName, string itemId)
...
namespace Example
{
    public class DeleteSubscriptionItemExample
    {
        public static void Main()
        {
            Configuration.Default.BasePath = "http://localhost";
            ...
            {
                // Delete Item
                AnyType result = apiInstance.DeleteSubscriptionItem(accountName, itemId);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
                Debug.Print("Exception when calling PaymentsApi.DeleteSubscriptionItem: " + e.Message );
                Debug.Print("Status Code: "+ e.ErrorCode);
                Debug.Print(e.StackTrace);
            }
        }
