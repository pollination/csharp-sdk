...
> AppServerRestPaymentsDtoInvoicePreview GetNextInvoice (string accountName)
...
namespace Example
{
    public class GetNextInvoiceExample
    {
        public static void Main()
        {
            ...
            {
                // Get Next Invoice
                AppServerRestPaymentsDtoInvoicePreview result = apiInstance.GetNextInvoice(accountName);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
...
[**AppServerRestPaymentsDtoInvoicePreview**](AppServerRestPaymentsDtoInvoicePreview.md)
