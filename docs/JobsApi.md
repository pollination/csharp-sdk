...
> AnyType SearchJobFolder (string owner, string name, string jobId, List<string> path = null, int? page = null, int? perPage = null)
...
namespace Example
{
    public class SearchJobFolderExample
    {
        public static void Main()
        {
            ...
            {
                // List files/folders in a job folder
                AnyType result = apiInstance.SearchJobFolder(owner, name, jobId, path, page, perPage);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
