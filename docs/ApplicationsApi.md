...
> ApplicationList ListApplications (string search = null, List<string> ids = null, List<string> names = null, List<string> owner = null, bool? _public = null, List<string> permissions = null, List<string> keywords = null, ApplicationSortKey? sortBy = null, SortEnum? sortOrder = null, int? page = null, int? perPage = null)
...
namespace Example
{
    public class ListApplicationsExample
    {
        public static void Main()
        {
            ...
            {
                // List Applications
                ApplicationList result = apiInstance.ListApplications(search, ids, names, owner, _public, permissions, keywords, sortBy, sortOrder, page, perPage);
                Debug.WriteLine(result);
            }
            catch (ApiException e)
            {
